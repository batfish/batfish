/**
 * Check that each IPSEC VPN definition for each configuration corresponds
 * uniquely to some other IPSEC VPN definition on some other configuration.
 * @param no_check_endpoint If set to true, don't check for matching IPSEC VPN definitions
 * @param no_check_unique If set to true, don't check for UNIQUE matching IPSEC VPN definitions
 * @param no_check_ike If set to true, don't check for compatible IKE proposals
 * @param no_check_ipsec If set to true, don't check for compatible IPSEC proposals
 * @param no_check_psk If set to true, don't check for matching pre-shared-keys
 */
defaults {
