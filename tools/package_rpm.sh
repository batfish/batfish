...
package() {
   ...
   BATFISH_JAR_NAME=batfish-${VERSION}.jar
   BATFISH_JAR_SRC=$BATFISH_PATH/projects/batfish/target/$BATFISH_JAR_NAME
   BATFISH_JAR=${DATA_DIR}/$BATFISH_JAR_NAME
   BATFISH_JAR_P=${PBASE}${BATFISH_JAR}
   BATFISH_PROPERTIES_NAME=batfish.properties
   BATFISH_PROPERTIES_SRC=$BATFISH_PATH/projects/batfish/target/$BATFISH_PROPERTIES_NAME
   ...
   CLIENT_JAR_NAME=batfish-client-${VERSION}.jar
   CLIENT_JAR_SRC=$BATFISH_PATH/projects/batfish-client/target/$CLIENT_JAR_NAME
   CLIENT_JAR=${DATA_DIR}/$CLIENT_JAR_NAME
   CLIENT_JAR_P=${PBASE}${CLIENT_JAR}
   CLIENT_PROPERTIES_NAME=client.properties
   CLIENT_PROPERTIES_SRC=$BATFISH_PATH/projects/batfish-client/target/$CLIENT_PROPERTIES_NAME
   ...
   COORDINATOR_JAR_NAME=coordinator-${VERSION}.jar
   COORDINATOR_JAR_SRC=$BATFISH_PATH/projects/coordinator/target/${COORDINATOR_JAR_NAME}
   ...
   COORDINATOR_PROPERTIES_SRC=${BATFISH_PATH}/projects/coordinator/target/${COORDINATOR_PROPERTIES_NAME}
   ...
   COORDINATOR_KEYSTORE_SRC=${BATFISH_PATH}/projects/coordinator/target/${COORDINATOR_KEYSTORE_NAME}
   ...
   QUESTION_JAR_NAME=question-${VERSION}.jar
   QUESTION_JAR_SRC=${BATFISH_PATH}/projects/question/target/${QUESTION_JAR_NAME}
