...
...
```
This makes the parser more fragile and can break recovery in the event that a child rule is only partially recognized. This means an unrecognized line early in a stanza can take out all the
rest of the lines.
