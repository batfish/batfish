...
public class RoutesAnswererTest {
                ...
                Arrays.stream(configs)
                    ...
                    .collect(
                        ImmutableTable.toImmutableTable(
                            ...
                            e -> FinalMainRib.forTesting(e.getValue().getStaticRoutes()))))
            .build();
      }
    };
  }
  ...
  private static @Nonnull FinalMainRib makeRib(AbstractRoute... routes) {
    return FinalMainRib.forTesting(Arrays.asList(routes));
  }
