...
public class RoutesAnswererUtil {
  ...
  static Row bgpRouteToRow(
    ...
    return Row.builder(columnMetadataMap)
        ...
        .put(COL_CLUSTER_LIST, bgpv4Route.getClusterList().size() == 0 ? null : bgpv4Route.getClusterList())
  ...
  static Row evpnRouteToRow(
    ...
    return Row.builder(columnMetadataMap)
        ...
        .put(COL_CLUSTER_LIST, evpnRoute.getClusterList().size() == 0 ? null : evpnRoute.getClusterList())
