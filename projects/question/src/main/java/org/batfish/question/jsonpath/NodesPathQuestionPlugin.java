...
public class NodesPathQuestionPlugin extends QuestionPlugin {
  ...
  public static class NodesPathAnswerElement implements AnswerElement {
    ...
    public String prettyPrint() {
      return JsonPathQuestionPlugin.JsonPathAnswerElement.prettyPrint(_results);
    }
  ...
  public static class NodesPathAnswerer extends Answerer {
    ...
    public AnswerElement answerDiff() {
      ...
      _batfish.popEnvironment();
      _batfish.pushBaseEnvironment();
      NodesPathAnswerer beforeAnswerer = (NodesPathAnswerer) create(_question, _batfish);
      NodesPathAnswerElement before = beforeAnswerer.answer();
      _batfish.popEnvironment();
      _batfish.pushDeltaEnvironment();
      NodesPathAnswerer afterAnswerer = (NodesPathAnswerer) create(_question, _batfish);
  ...
  public static class NodesPathDiffAnswerElement implements AnswerElement {
    ...
    public NodesPathDiffAnswerElement(NodesPathAnswerElement before, NodesPathAnswerElement after) {
      _results = new TreeMap<>();
    ...
    @Override
    public String prettyPrint() {
      return JsonPathQuestionPlugin.JsonPathDiffAnswerElement.prettyPrint(_results);
    }
