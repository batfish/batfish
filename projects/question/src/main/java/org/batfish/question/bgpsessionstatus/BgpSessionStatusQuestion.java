...
public class BgpSessionStatusQuestion extends BgpSessionQuestion {
   ...
   *
   * @param nodes Node specifier input to match the nodes names for one end of the sessions. Default
   *     is all nodes.
   * @param remoteNodes Node specifier input to match the nodes names for the other end of the
