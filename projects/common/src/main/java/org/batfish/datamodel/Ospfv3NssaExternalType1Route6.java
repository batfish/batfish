...
/**
 * An IPv6 OSPFv3 NSSA external type-1 route.
 *
 * <p>This represents an NSSA Type-7/N1 advertisement before translation
 * into an ordinary Type-5/E1 advertisement.
 */
@ParametersAreNonnullByDefault
public final class Ospfv3NssaExternalType1Route6
  ...
  @JsonCreator
  private static Ospfv3NssaExternalType1Route6 create(
    ...
    return new Ospfv3NssaExternalType1Route6(
        network,
        firstNonNull(
            nextHopInterface,
  ...
  /** Create a locally originated NSSA N1 route. */
  public Ospfv3NssaExternalType1Route6(
      Prefix6 network,
  ...
  /** Create a learned NSSA N1 route. */
  public Ospfv3NssaExternalType1Route6(
      Prefix6 network,
      String nextHopInterface,
      @Nullable Ip6 nextHopIp,
    ...
    checkArgument(
        metric >= 0L,
        "Invalid OSPFv3 N1 metric %s",
        metric);

    checkArgument(
        lsaMetric >= 0L,
        "Invalid OSPFv3 N1 LSA metric %s",
        lsaMetric);

    checkArgument(
        costToAdvertiser >= 0L,
        "Invalid OSPFv3 N1 cost to advertiser %s",
        costToAdvertiser);

    checkArgument(
        metric >= lsaMetric,
        "OSPFv3 N1 metric %s is below LSA metric %s",
        metric,
        lsaMetric);
    ...
    checkArgument(
        metric - lsaMetric
            == costToAdvertiser,
        "OSPFv3 N1 metric %s does not equal LSA metric %s plus cost %s",
        metric,
        lsaMetric,
        costToAdvertiser);
  ...
  public boolean equals(
    ...
    Ospfv3NssaExternalType1Route6 rhs =
        (Ospfv3NssaExternalType1Route6) o;
