...
/** An IPv6 OSPFv3 inter-area route. */
@ParametersAreNonnullByDefault
public final class Ospfv3InterAreaRoute6
    extends AbstractRoute6 {

  private static final String PROP_AREA = "area";

  @JsonCreator
  private static Ospfv3InterAreaRoute6 create(
    ...
    return new Ospfv3InterAreaRoute6(
        network,
        firstNonNull(
            nextHopInterface,
  ...
  public Ospfv3InterAreaRoute6(
    ...
    checkArgument(
        metric >= 0,
        "Invalid OSPFv3 inter-area metric %s",
        metric);
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (!(o instanceof Ospfv3InterAreaRoute6)) {
      return false;
    }

    Ospfv3InterAreaRoute6 rhs =
        (Ospfv3InterAreaRoute6) o;
