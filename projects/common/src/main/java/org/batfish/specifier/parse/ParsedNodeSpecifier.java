...
public final class ParsedNodeSpecifier implements NodeSpecifier {
  ...
  ParsedNodeSpecifier(NodeAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedNodeSpecifier parse(String input) {
    return new ParsedNodeSpecifier(getAst(input));
  }

  static NodeAstNode getAst(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.NODE_SPECIFIER, input);
    checkArgument(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedNodeSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedNodeSpecifier) o)._ast);
  }
