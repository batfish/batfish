...
import org.batfish.specifier.parse.ParsedIpSpaceSpecifier.IpSpaceAstNodeToIpSpace;

/** An {@link InterfaceSpecifier} that resolves based on the AST generated by {@link Parser}. */
@ParametersAreNonnullByDefault
public final class ParsedInterfaceSpecifier implements InterfaceSpecifier {
    ...
    public Set<NodeInterfacePair> visitInterfaceWithNodeInterfaceAstNode(
      ...
      return Sets.intersection(
          new NodeSpecifierInterfaceSpecifier(
                  new ParsedNodeSpecifier(interfaceWithNodeInterfaceAstNode.getNodeAstNode()))
              .resolve(_nodes, _ctxt),
          new ParsedInterfaceSpecifier(interfaceWithNodeInterfaceAstNode.getInterfaceAstNode())
              .resolve(_nodes, _ctxt));
    }
  ...
  ParsedInterfaceSpecifier(InterfaceAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedInterfaceSpecifier parse(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.INTERFACE_SPECIFIER, input);
    checkArgument(
        ast instanceof InterfaceAstNode,
        "ParsedInterfaceSpecifier requires an InterfaceSpecifier input");

    return new ParsedInterfaceSpecifier((InterfaceAstNode) ast);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedInterfaceSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedInterfaceSpecifier) o)._ast);
  }
