...
public final class ParsedIpProtocolSpecifier implements IpProtocolSpecifier {
  ...
  ParsedIpProtocolSpecifier(IpProtocolAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedIpProtocolSpecifier parse(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.IP_PROTOCOL_SPECIFIER, input);
    checkArgument(
        ast instanceof IpProtocolAstNode,
        "ParsedIpProtocolSpecifier requires an IP protocol specifier input");

    return new ParsedIpProtocolSpecifier((IpProtocolAstNode) ast);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedIpProtocolSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedIpProtocolSpecifier) o)._ast);
  }
