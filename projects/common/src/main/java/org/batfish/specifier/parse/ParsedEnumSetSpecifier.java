...
public final class ParsedEnumSetSpecifier<T> implements EnumSetSpecifier<T> {
  ...
  ParsedEnumSetSpecifier(EnumSetAstNode ast, Collection<T> allValues) {
    this(ast, allValues, ImmutableMap.of());
  }

  @SuppressWarnings("unchecked")
  ParsedEnumSetSpecifier(EnumSetAstNode ast, Grammar grammar) {
    this(
        ast,
  ...
  private ParsedEnumSetSpecifier(
   ...
   */
  public static <T> ParsedEnumSetSpecifier<T> parse(String input, Grammar grammar) {
    ...
    return new ParsedEnumSetSpecifier<>((EnumSetAstNode) ast, grammar);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedEnumSetSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedEnumSetSpecifier) o)._ast);
  }
