...
public final class ParsedAppSpecifier implements ApplicationSpecifier {
  ...
  ParsedAppSpecifier(AppAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedAppSpecifier parse(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.APPLICATION_SPECIFIER, input);
    checkArgument(
        ast instanceof AppAstNode, "ParsedAppSpecifier requires an IP protocol specifier input");

    return new ParsedAppSpecifier((AppAstNode) ast);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedAppSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedAppSpecifier) o)._ast);
  }
