...
/** A class that represents an auto complete suggestion generated by {@link ParsedAutoComplete} */
@ParametersAreNonnullByDefault
final class ParsedAutoCompleteSuggestion {
  ...
  ParsedAutoCompleteSuggestion(String text, int insertionIndex, Anchor.Type anchorType) {
    this(text, anchorType.getHint(), insertionIndex, anchorType);
  }

  ParsedAutoCompleteSuggestion(
  ...
  public boolean equals(Object o) {
    if (!(o instanceof ParsedAutoCompleteSuggestion)) {
      return false;
    }
    return Objects.equals(_anchorType, ((ParsedAutoCompleteSuggestion) o)._anchorType)
        && Objects.equals(_description, ((ParsedAutoCompleteSuggestion) o)._description)
        && Objects.equals(_hint, ((ParsedAutoCompleteSuggestion) o)._hint)
        && Objects.equals(_insertionIndex, ((ParsedAutoCompleteSuggestion) o)._insertionIndex)
        && Objects.equals(_text, ((ParsedAutoCompleteSuggestion) o)._text);
  }
  ...
  static AutocompleteSuggestion toAutoCompleteSuggestion(ParsedAutoCompleteSuggestion suggestion) {
   ...
   */
  @VisibleForTesting
  static String completeDescriptionIfNeeded(ParsedAutoCompleteSuggestion suggestion) {
  ...
  static List<AutocompleteSuggestion> toAutoCompleteSuggestions(
      Collection<ParsedAutoCompleteSuggestion> suggestions) {
    return suggestions.stream()
        .map(ParsedAutoCompleteSuggestion::toAutoCompleteSuggestion)
