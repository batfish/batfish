...
public final class ParsedRoutingPolicySpecifier implements RoutingPolicySpecifier {
  ...
  ParsedRoutingPolicySpecifier(RoutingPolicyAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedRoutingPolicySpecifier parse(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.ROUTING_POLICY_SPECIFIER, input);

    checkArgument(
        ast instanceof RoutingPolicyAstNode,
        "ParsedRoutingPolicySpecifier requires an RoutingPolicySpecifier input");

    return new ParsedRoutingPolicySpecifier((RoutingPolicyAstNode) ast);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedRoutingPolicySpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedRoutingPolicySpecifier) o)._ast);
  }
