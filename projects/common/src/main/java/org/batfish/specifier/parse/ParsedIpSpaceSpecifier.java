 ...
 * generated by {@link org.batfish.specifier.parse.Parser}.
 */
public final class ParsedIpSpaceSpecifier implements IpSpaceAssignmentSpecifier, IpSpaceSpecifier {
  ...
  static final class IpSpaceAstNodeToIpSpace implements IpSpaceAstNodeVisitor<IpSpace> {
    ...
    public @Nonnull IpSpace visitLocationIpSpaceAstNode(
      ...
      return LocationIpSpaceSpecifier.computeIpSpace(
          new ParsedLocationSpecifier(locationIpSpaceAstNode.getLocationAst()).resolve(_ctxt),
          _ctxt);
    }
  ...
  ParsedIpSpaceSpecifier(IpSpaceAstNode ast) {
    _ast = ast;
  }
   ...
   */
  public static ParsedIpSpaceSpecifier parse(String input) {
    AstNode ast = SpecifierAstBuilder.getAst(Grammar.IP_SPACE_SPECIFIER, input);
    checkArgument(
        ast instanceof IpSpaceAstNode, "ParsedIpSpaceSpecifier requires an IpSpace input");

    return new ParsedIpSpaceSpecifier((IpSpaceAstNode) ast);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParsedIpSpaceSpecifier)) {
      return false;
    }
    return Objects.equals(_ast, ((ParsedIpSpaceSpecifier) o)._ast);
  }
