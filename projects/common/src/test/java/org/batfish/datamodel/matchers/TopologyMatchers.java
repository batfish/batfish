...
public class TopologyMatchers {
  ...
  private static final class IsNeighborOfNode extends TypeSafeDiagnosingMatcher<NodeInterfacePair> {
  ...
  private static final class WithNode extends TypeSafeDiagnosingMatcher<String> {
