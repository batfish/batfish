...
public class ParserEnumSetTest {
    ...
    assertThat(
        ...
        equalTo(
            Stream.concat(
                    ...
                    ImmutableSet.of(
                        new ParsedAutoCompleteSuggestion("/", 0, Type.ENUM_SET_REGEX),
                        new ParsedAutoCompleteSuggestion("!", 0, Type.ENUM_SET_NOT))
                        .stream())
  ...
  public void testAutoCompleteSuperStrings() {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion(",", 11, Type.ENUM_SET_SET_OP),
            new ParsedAutoCompleteSuggestion(
                BgpSessionStatus.ESTABLISHED.toString(), 0, Type.ENUM_SET_VALUE),
            new ParsedAutoCompleteSuggestion(
                BgpSessionStatus.NOT_ESTABLISHED.toString(), 0, Type.ENUM_SET_VALUE)));
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion(
                BgpSessionStatus.NOT_ESTABLISHED.toString(), 0, Type.ENUM_SET_VALUE),
            new ParsedAutoCompleteSuggestion(",", 15, Type.ENUM_SET_SET_OP)));
  }
