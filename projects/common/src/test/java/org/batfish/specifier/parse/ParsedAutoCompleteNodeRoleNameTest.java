...
import static org.batfish.specifier.parse.Anchor.Type.NODE_ROLE_DIMENSION_NAME;
import static org.batfish.specifier.parse.Anchor.Type.NODE_ROLE_NAME;
...
/**
 * Tests for node role name auto completion in {@link ParsedAutoComplete}. The testing strategy is
 * in three parts:
 *
 * <ol>
 ...
 * </ol>
 */
public class ParsedAutoCompleteNodeRoleNameTest {
  ...
  public void testAutoCompleteNodeRoleName() {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("r11", 42, NODE_ROLE_NAME),
            new ParsedAutoCompleteSuggestion("r12", 42, NODE_ROLE_NAME)));
  ...
  public void testAutoCompleteNodeRoleNamePrefix() {
    ...
    assertThat(
        ...
        containsInAnyOrder(new ParsedAutoCompleteSuggestion("r11", 42, NODE_ROLE_NAME)));
  ...
  public void testE2eNoTailNoMatchingDimension() {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion(",", query.length(), NODE_ROLE_AND_DIMENSION_TAIL)));
  ...
  public void testE2eNoTailMatchingDimension() {
    ...
    assertThat(
        getPAC(query, Grammar.NODE_SPECIFIER).run(),
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("dim1", 6, NODE_ROLE_DIMENSION_NAME),
            new ParsedAutoCompleteSuggestion("dim2", 6, NODE_ROLE_DIMENSION_NAME),
            new ParsedAutoCompleteSuggestion(",", query.length(), NODE_ROLE_AND_DIMENSION_TAIL)));
  ...
  public void testE2eNoRoleNamePrefix() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("r11", query.length(), NODE_ROLE_NAME),
            new ParsedAutoCompleteSuggestion("r12", query.length(), NODE_ROLE_NAME));
  ...
  public void testE2eRoleNamePrefix() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("r11", 11, NODE_ROLE_NAME),
  ...
  public void testE2eLocationFuncRoleNamePrefix() {
    ...
    assertThat(
        getPAC(query, Grammar.LOCATION_SPECIFIER).run(),
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("r11", 18, NODE_ROLE_NAME),
            new ParsedAutoCompleteSuggestion(")", query.length(), OPERATOR_END)));
  }
  ...
  public void testE2eSpacesRoleNamePrefix() {
    ...
    assertThat(
        getPAC(query, Grammar.LOCATION_SPECIFIER).run(),
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("r11", 16, NODE_ROLE_NAME),
            new ParsedAutoCompleteSuggestion(")", query.length(), OPERATOR_END)));
  }
}
