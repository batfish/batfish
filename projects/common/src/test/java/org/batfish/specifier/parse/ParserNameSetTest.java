...
public class ParserNameSetTest {
  ...
  public void testAutoCompleteEmpty() {
    assertThat(
        ...
        equalTo(
            ImmutableSet.of(
                new ParsedAutoCompleteSuggestion("mlag1", 0, Type.NAME_SET_NAME),
                new ParsedAutoCompleteSuggestion("mlag2", 0, Type.NAME_SET_NAME),
                new ParsedAutoCompleteSuggestion("other", 0, Type.NAME_SET_NAME),
                new ParsedAutoCompleteSuggestion("/", 0, Type.NAME_SET_REGEX))));
  }
    ...
    assertThat(
        ...
        equalTo(
            ImmutableSet.of(
                new ParsedAutoCompleteSuggestion("mlag1", 0, Type.NAME_SET_NAME),
                new ParsedAutoCompleteSuggestion("mlag2", 0, Type.NAME_SET_NAME),
                new ParsedAutoCompleteSuggestion(",", query.length(), Type.NAME_SET_SET_OP))));
  }
