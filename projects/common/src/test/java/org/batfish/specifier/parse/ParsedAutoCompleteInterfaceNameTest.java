...
/**
 * Tests for interface name auto completion in {@link ParsedAutoComplete}. The testing strategy is
 * in three parts:
 *
 * <ol>
 *   <li>testFindPreceding* tests in {@link ParsedAutoCompleteTest} check that we are correctly
 ...
 * </ol>
 */
public class ParsedAutoCompleteInterfaceNameTest {
  ...
  private static ParsedAutoComplete getPAC(String query, Grammar grammar) {
    return getPAC(query, grammar, testCompletionMetadata);
  }

  private static ParsedAutoComplete getPAC(
  ...
  public void testAutoCompleteInterfaceNameNodeNameOrRegex() {
    Set<ParsedAutoCompleteSuggestion> n1interfaces =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("eth11", 42, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 42, INTERFACE_NAME));
  ...
  public void testAutoCompleteInterfaceNameComplexNodeExpression() {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("eth11", 42, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 42, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth21", 42, INTERFACE_NAME)));
  }
  ...
  public void testAutoCompleteInterfaceNameInterfaceNamePrefix() {
    ...
    assertThat(
        ...
        containsInAnyOrder(new ParsedAutoCompleteSuggestion("eth12", 42, INTERFACE_NAME)));
  ...
  public void testE2eNoTailMatchingInterface() {
    ...
    assertThat(
        getPAC(query, Grammar.INTERFACE_SPECIFIER).run(),
        containsInAnyOrder(
            new ParsedAutoCompleteSuggestion("eth11", 0, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 0, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("[", query.length(), NODE_AND_INTERFACE_TAIL),
            new ParsedAutoCompleteSuggestion("&", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion(",", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion("\\", query.length(), INTERFACE_SET_OP)));
  ...
  public void testE2eNoInterfacePrefix() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("eth11", query.length(), INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", query.length(), INTERFACE_NAME),
  ...
  public void testE2eComplexNode() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("eth11", 12, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 12, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth21", 12, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("]", query.length(), OPERATOR_END),
            new ParsedAutoCompleteSuggestion("&", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion(",", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion("\\", query.length(), INTERFACE_SET_OP));
  ...
  public void testE2eLocationPrefix() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("eth11", 11, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 11, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("])", query.length(), OPERATOR_END),
            new ParsedAutoCompleteSuggestion("&", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion(",", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion("\\", query.length(), INTERFACE_SET_OP));
  ...
  public void testE2eSpacesInterfacePrefix() {
    ...
    Set<ParsedAutoCompleteSuggestion> expected =
        ImmutableSet.of(
            new ParsedAutoCompleteSuggestion("eth11", 7, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("eth12", 7, INTERFACE_NAME),
            new ParsedAutoCompleteSuggestion("]", query.length(), OPERATOR_END),
            new ParsedAutoCompleteSuggestion("&", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion(",", query.length(), INTERFACE_SET_OP),
            new ParsedAutoCompleteSuggestion("\\", query.length(), INTERFACE_SET_OP));
