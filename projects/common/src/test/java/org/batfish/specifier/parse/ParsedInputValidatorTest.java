...
/** Tests for {@link ParsedInputValidator} */
public class ParsedInputValidatorTest {

  private static ParsedInputValidator getTestPIV(String query) {
    return getTestPIV(
        query,
  ...
  private static ParsedInputValidator getTestPIV(
  ...
  private static ParsedInputValidator getTestPIV(String query, NodeRolesData nodeRolesData) {
    return getTestPIV(
