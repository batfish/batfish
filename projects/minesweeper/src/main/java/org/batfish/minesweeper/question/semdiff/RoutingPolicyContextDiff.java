...
/**
 * This class describes the diff of the context (prefix-lists, community-lists, as-path lists) under
 * which a RoutingPolicy is interpreted.
 */
public class RoutingPolicyContextDiff {
   ...
   * hence there is no point also looking for references used through the referencePolicy.
   *
  ...
  public boolean equals(Object o) {
    ...
    // Ignore the configuration; it is only used to build the sets below.
