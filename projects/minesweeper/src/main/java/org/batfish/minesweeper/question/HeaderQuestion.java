...
public class HeaderQuestion extends Question {
  ...
  private static final String PROP_ECMP_WIDTH = "ecmpWidth";
  ...
  private static final String PROP_MODEL_IGP = "modelIgp";
  ...
  public HeaderQuestion() {
    ...
    _bgpRanking.add(BgpDecisionVariable.CLUSTERLEN);
  ...
  @JsonProperty(PROP_ECMP_WIDTH)
  public int getEcmpWidth() {
    return _ecmpWidth;
  }
  ...
  @JsonProperty(PROP_ECMP_WIDTH)
  public void setEcmpWidth(int k) {
    _ecmpWidth = k;
  }
  ...
  @JsonProperty(PROP_MODEL_IGP)
  public void setModelIgp(boolean x) { this._modelIgp = x; }
