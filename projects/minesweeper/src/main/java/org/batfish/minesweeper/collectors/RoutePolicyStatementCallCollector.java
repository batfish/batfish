 ...
 * callees.
 */
public class RoutePolicyStatementCallCollector extends RoutePolicyStatementMatchCollector<String> {

  public RoutePolicyStatementCallCollector(
      BooleanExprVisitor<Set<String>, Tuple<Set<String>, Configuration>> booleanExprVisitor) {
    super(booleanExprVisitor);
  }
