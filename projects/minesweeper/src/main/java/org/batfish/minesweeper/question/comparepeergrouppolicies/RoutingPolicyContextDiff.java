...
public final class RoutingPolicyContextDiff {
   ...
   * automatically recursively checked for equality by this method (but one may separately check
   * them by another call to this method).
   *
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RoutingPolicyContextDiff)) {
      return false;
    }
