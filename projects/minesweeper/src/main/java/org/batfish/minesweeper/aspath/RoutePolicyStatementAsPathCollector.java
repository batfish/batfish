...
public class RoutePolicyStatementAsPathCollector
  ...
  @Override
  public Set<SymbolicAsPathRegex> visitRemoveTunnelAttribute(
      RemoveTunnelAttribute removeTunnelAttribute, Configuration arg) {
    return ImmutableSet.of();
  }
  ...
  @Override
  public Set<SymbolicAsPathRegex> visitSetTunnelAttribute(
      SetTunnelAttribute setTunnelAttribute, Configuration arg) {
    return ImmutableSet.of();
  }
