...
public class SearchRoutePoliciesAnswererTest {
  ...
  public void testSetMetricIncrOverflow() {
    RoutingPolicy policy =
        _policyBuilder
            .addStatement(new SetMetric(new IncrementMetric(0x80000000L)))
            .addStatement(new StaticStatement(Statements.ExitAccept))
            .build();
    ...
    SearchRoutePoliciesQuestion question =
        new SearchRoutePoliciesQuestion(
            DEFAULT_DIRECTION,
            BgpRouteConstraints.builder().setMed(LongSpace.of(0x80000000L)).build(),
            EMPTY_CONSTRAINTS,
            HOSTNAME,
            policy.getName(),
            Action.PERMIT,
    ...
    BgpRouteDiffs diff =
        new BgpRouteDiffs(
            ImmutableSet.of(new BgpRouteDiff(BgpRoute.PROP_METRIC, "2147483648", "4294967295")));
  ...
  public void testUnsupportedStatementAvoid() {
    ...
    BgpRoute inputRoute =
        BgpRoute.builder()
            // the model will avoid the path containing the unsupported PrependAsPath statement
