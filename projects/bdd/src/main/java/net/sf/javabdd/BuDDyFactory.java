...
/**
 * An implementation of BDDFactory that relies on the BuDDy library through a native interface. You
 * can use this by calling the "BuDDyFactory.init()" method with the desired arguments. This will
 * return you an instance of the BDDFactory class that you can use. Call "done()" on that instance
 * when you are finished.
 *
 * <p>This class (and the BuDDy library) do NOT support multithreading. Furthermore, there can be
...
public class BuDDyFactory extends BDDFactory {
  ...
  public static BDDFactory init(int nodenum, int cachesize) {
    BuDDyFactory f;
    if (USE_FINALIZER) f = new BuDDyFactoryWithFinalizer();
    else f = new BuDDyFactory();
  ...
  protected void initialize(int nodenum, int cachesize) {
    if (INSTANCE != null) throw new InternalError("Error: BDDFactory already initialized.");
    INSTANCE = this;
