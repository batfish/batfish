 ...
 *
 * <p>It will probably go much faster if we can figure out how to make the exclude-operator native
 * [current version makes calls to restrict and diff]...
 *
 * @see ZDD
 * @see ZDDCSP
 */
  ...
  public static void main(String[] args) {
    for (String str : args) {
      ...
      JDDConsole.out.printf(
          "ZDDCSP-Queen\tSolutions=%.0f\tN=%d\tmem=%s\ttime=%d\n",
