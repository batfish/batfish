 ...
 *
 * Given to sets A = { x0, x1, ..., xn } and B = { x0, x1, ..., xn } we build
 * the equality relation R: A x B.
 *
 * A and B are encoded using two sets of BDD variables (a's and b's).
 * We consider two different variable orderings: disjoint
 * (a0, a1, ... b0, b1, ...)  and interleaved (a0, b0, a1, b1, ...) and
