 ...
 *
 * <p>we have borrowed this from JavaBDD, to see how much of the [lack of] speed depends on Java...
 *
...
public class BDDQueens extends BDD implements Queens {
  ...
  public BDDQueens(int N) {
    ...
    for (int i = 0; i < N; i++) {
      int e = 0;
      for (int j = 0; j < N; j++) e = orTo(e, X(i, j));
      queen = andTo(queen, e);
      deref(e);
    }
  ...
  public static void main(String[] args) {
    ...
    for (String str : args) {
      ...
      JDDConsole.out.printf(
          "BDD-Queen\tSolutions=%.0f\tN=%d\tmem=%s\ttime=%d\n",
