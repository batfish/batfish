 ...
 *
 * <p>This class demonstrates how the Fibonacci numbers can be computed recursively but still a bit
 * efficient by using a cache...
 *
 * <p>See this more as a (very simple) tutorial on how the caches work in JDD than an example on
 * what JDD can do.
 *
 * <p>and oh yeah...for those of you who slept during the math lessons:
 *
 * <pre>
 *   F(0) = 0
 *   F(1) = 1
