...
/**
 * handles all allocation of *DD related large arrays. This way, we can keep track of the allocated
 * memory during the lifetime of JDD.
 */
public class Allocator {
  ...
  public static final String[] TYPE_NAMES = {"int", "short", "byte", "double", "char", "boolean"};
   ...
   *
   * <p>Note that in general OutOfMemoryError cannot be cought, so this function will probably never
   * be called...
   */
  ...
  public static void showStats() {
    JDDConsole.out.printf(
        "Allocator total memory: %d, stats (type,count,max,total):\n", stats_total_bytes);
