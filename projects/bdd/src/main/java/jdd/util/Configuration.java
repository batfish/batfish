...
public class Configuration {
  ...
  public static final int DEFAULT_MAX_NODE_FREE = DEFAULT_MAX_NODE_INCREASE;
  ...
  /** cache for relProd */
  public static final int bddRelprodcacheDiv = DEFAULT_BDD_RELPRODCACHE_DIV;

  /** how little the replace cache is, range: 2-8 */
  public static final int bddReplacecacheDiv = DEFAULT_BDD_REPLACECACHE_DIV;

  /** how little the satcount cache is, range: 4-32 */
  public static final int bddSatcountDiv = DEFAULT_BDD_SATCOUNT_DIV;
   ...
   */
  public static final int DEFAULT_ZDD_CACHE_SIZE = DEFAULT_BDD_CACHE_SIZE;
  ...
  /**
   * if less than this precent nodes are free, we will garbage collect, or grow the nodetable,
   * range: 5-40. [this constant is tested against MAX_NODE_FREE ]
   */
  ...
  public static final int maxCacheGrows = DEFAULT_MAX_CACHE_GROWS;

  /** loadfactor required for Cache to grow, rang: 50-99 */
  public static final int minCacheLoadfactorToGrow = DEFAULT_MIN_CACHE_LOADFACTOR_TO_GROW;
