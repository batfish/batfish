 ...
 *
 * <p>A trace file is assumed to have the '.trace' posfix. Any file with the 'README' posfix is
 * assumed to be an information file and is dumped to stdout.
 */
public class BDDTraceSuite {

  /**
   * filename is the name of zip file, initial_size is the suggested "base" for deciding the initial
   * of the nodetable. if initial_size is -1, it is ignored and BDDTrace's default value is used
   */
