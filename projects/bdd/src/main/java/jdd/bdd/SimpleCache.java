...
public class SimpleCache extends CacheBase {
  ...
  protected long hit,
      miss,
      last_hit,
      last_access; // cache hits and misses, hit/acces-count since last grow
   ...
   *
   * <p>returns false if element not found. user should copy the hash value from
   * SimpleCache.hash_value before doing any more cache-operations!
   */
