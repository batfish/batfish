...
:
  LOGGING
  ( no_logging_event_null | no_logging_format_null | no_logging_policy_null | no_logging_qos_null | no_logging_relogging_interval_null | no_logging_repeat_messages_null | no_logging_synchronous_null )
;
