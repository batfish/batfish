...
:
  ...
  | s_ipv6_address
  | s_ipv6_ospfv3_area
  | s_ipv6_ospfv3_authentication
  | s_ipv6_ospfv3_encryption
  | s_ipv6_ospfv3_bfd
  | s_ipv6_ospfv3_cost
  ...
  | s_ospf_area_stub
  | s_ospf_area_nssa
  | s_ospfv3_area_authentication
  | s_ospfv3_area_encryption
  | s_ospfv3_active_backbone
  | s_ospfv3_bfd_all_interfaces
  | s_ospfv3_area_range
  ...
  | s_ospfv3_graceful_restart
  | s_ospfv3_timers_throttle_spf
  | s_ospfv3_timers_throttle_lsa
  | s_ospfv3_timers_lsa_arrival
  | s_ospfv3_max_metric_router_lsa
  ...
  | s_router_bgp
  | s_route_redistribute_active_routes_only
  | s_route_map
...
ospfv3_ipsec_authentication
:
  IPSEC SPI WORD ospfv3_auth_type
    (ospfv3_key_type WORD)?
;

s_ipv6_ospfv3_authentication
:
  IPV6 OSPFV3 AUTHENTICATION NULL NEWLINE
  | IPV6 OSPFV3 AUTHENTICATION
      ospfv3_ipsec_authentication NEWLINE
  | NO IPV6 OSPFV3 AUTHENTICATION NEWLINE
;
...
s_ipv6_ospfv3_encryption
:
  IPV6 OSPFV3 ENCRYPTION NULL NEWLINE
  | IPV6 OSPFV3 ENCRYPTION
      ospfv3_ipsec_encryption NEWLINE
  | NO IPV6 OSPFV3 ENCRYPTION NEWLINE
;

s_ipv6_ospfv3_bfd
:
  IPV6 OSPFV3 BFD DISABLE? NEWLINE
  | NO IPV6 OSPFV3 BFD NEWLINE
;
...
s_route_redistribute_active_routes_only
:
  NO? ROUTE_REDISTRIBUTE ACTIVE_ROUTES_ONLY NEWLINE
;
...
s_set_metric_type
:
  SET METRIC_TYPE EXTERNAL ospf_external_metric_type NEWLINE
;
...
s_router_ospfv3
:
  NO? ROUTER OSPFV3 WORD (VRF WORD)? NEWLINE
;
...
s_ospfv3_area_authentication
:
  AREA WORD AUTHENTICATION
    ospfv3_ipsec_authentication NEWLINE
  | NO AREA WORD AUTHENTICATION NEWLINE
;

s_ospfv3_area_encryption
:
  AREA WORD ENCRYPTION
    ospfv3_ipsec_encryption NEWLINE
  | NO AREA WORD ENCRYPTION NEWLINE
;

s_ospfv3_active_backbone
:
  NO? ACTIVE_BACKBONE STUB_DEFAULT_ROUTE NEWLINE
;

s_ospfv3_bfd_all_interfaces
:
  NO? BFD ALL_INTERFACES NEWLINE
;
...
s_ospfv3_graceful_restart
:
  GRACEFUL_RESTART RESTART_INTERVAL WORD NEWLINE
  | NO GRACEFUL_RESTART RESTART_INTERVAL WORD? NEWLINE
  | GRACEFUL_RESTART HELPER STRICT_LSA_CHECK? NEWLINE
  | NO GRACEFUL_RESTART HELPER STRICT_LSA_CHECK? NEWLINE
  | GRACEFUL_RESTART IGNORE_LOST_INTERFACE NEWLINE
  | NO GRACEFUL_RESTART IGNORE_LOST_INTERFACE NEWLINE
;
...
:
  TIMERS THROTTLE SPF
    ...
    MAX_WAIT_TIME WORD
    NEWLINE
  | NO TIMERS THROTTLE SPF NEWLINE
;
...
:
  TIMERS THROTTLE LSA
    ...
    MAX_WAIT_TIME WORD
    NEWLINE
  | NO TIMERS THROTTLE LSA NEWLINE
;

s_ospfv3_timers_lsa_arrival
:
  TIMERS LSA_ARRIVAL WORD NEWLINE
  | NO TIMERS LSA_ARRIVAL NEWLINE
;
...
s_ospfv3_summary_address
:
  NO? SUMMARY_ADDRESS WORD ospfv3_summary_address_option? NEWLINE
;
...
null_statement
:
  (ACCESS_LIST | ALLOWED | APPLY | ANY | CONNECTED | COST | COUNT | DEFAULT_GATEWAY | DISTANCE | EQ | GT | LT | RANGE | ROUTED_IN | ROUTED_OUT | ADDRESS | AREA | ATTACH | VRF | BGP | IN | OUT | UNICAST | REMOTE_AS | NEIGHBOR | IPV4 | IPV6 | ADDRESS_FAMILY | ACTIVATE | ACTIVE_BACKBONE | HOSTNAME | INTERFACE | IP | LOOPBACK | LOCAL | LINK_LOCAL | MTU | NATIVE | NETWORK | NO | NO_ADVERTISE | NO_SUMMARY | NULLROUTE | OSPF | OSPFV3 | POINT_TO_POINT | REDISTRIBUTE | REJECT | ROUTE | ROUTER | ROUTER_ID | ROUTING | SHUTDOWN | SPEED | SOURCE_PROTOCOL | STATIC | SUMMARY_ADDRESS | STUB | STUB_DEFAULT_ROUTE | TAG | TRUNK | VIRTUAL_LINK | VLAN | PREFIX_LIST | SEQ | PERMIT | DENY | GE | LE | ROUTE_MAP | ROUTE_REDISTRIBUTE | ACTIVE_ROUTES_ONLY | MATCH | MAX_METRIC | MAXIMUM_PATHS | ON_STARTUP | ROUTER_LSA | SET | LOCAL_PREFERENCE | DEFAULT | PASSIVE | PASSIVE_INTERFACE | REFERENCE_BANDWIDTH | BROADCAST | DEAD_INTERVAL | HELLO_INTERVAL | DEFAULT_METRIC | ALWAYS | DEFAULT_INFORMATION | METRIC | METRIC_TYPE | ORIGINATE | DISABLE | ENABLE | EXTERNAL | INTER_AREA | INTRA_AREA | NSSA | DISTRIBUTE_LIST | PREFIX | PRIORITY | RETRANSMIT_INTERVAL | TRANSIT_DELAY | TYPE | AES | ALL_INTERFACES | AUTHENTICATION | BFD | CIPHERTEXT | DES | ENCRYPTION | HEX_STRING | IPSEC | MD5 | NULL | PLAINTEXT | SHA1 | SPI | THREE_DES | TYPE_1 | TYPE_2 | GRACEFUL_RESTART | HELPER | IGNORE_LOST_INTERFACE | RESTART_INTERVAL | STRICT_LSA_CHECK | HOLD_TIME | LSA | LSA_ARRIVAL | MAX_WAIT_TIME | SPF | START_TIME | THROTTLE | TIMERS | WORD)+ NEWLINE
;
