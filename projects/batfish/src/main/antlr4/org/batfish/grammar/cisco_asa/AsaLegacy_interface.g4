parser grammar AsaLegacy_interface;
...
:
   NO? SPANNING_TREE
   (
      ( if_st_bpdufilter_null | if_st_bpduguard_null | if_st_cost_null | if_st_guard_null | if_st_link_type_null | if_st_mst_null | if_st_port_null | if_st_port_priority_null | if_st_priority_null | if_st_protect_null | if_st_rstp_null | if_st_vlan_null )
      | if_st_portfast
      | NEWLINE
   )
;
