...
rbnx_template_peer
:
  TEMPLATE PEER peer = template_name NEWLINE rbnx_n_inner*
;

rbnx_template_peer_policy
:
  TEMPLATE PEER_POLICY policy = template_name NEWLINE rbnx_n_af_inner*
;

rbnx_template_peer_session
:
  TEMPLATE PEER_SESSION session = template_name NEWLINE rbnx_n_common*
;
