...
match_cluster_list_length_rm_stanza
:
   CLUSTER_LIST_LENGTH EQ DEC NEWLINE
;
...
match_condition_missing_prefix_list_rm_stanza
:
   CONDITION MISSING PREFIX_LIST
   (
      name_list += variable
   )+ NEWLINE
;
