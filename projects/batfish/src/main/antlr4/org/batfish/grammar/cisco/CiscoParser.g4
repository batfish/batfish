...
s_ip_aux_protocol_name
:
  SYSTEM | KERNEL | CONNECTED | STATIC | RIP | OSPF | ISIS | BGP | ANY
;

s_ip_protocol
:
  IP PROTOCOL (ip_protocol_name = s_ip_aux_protocol_name) ROUTE_MAP (ip_rm_name = variable) NEWLINE
;
