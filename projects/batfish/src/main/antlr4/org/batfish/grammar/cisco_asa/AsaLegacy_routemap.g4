parser grammar AsaLegacy_routemap;
...
:
   COMMUNITY name_list += variable_community_list+ EXACT_MATCH? NEWLINE
;
...
:
   SET COMMUNITY communities += standard_community+ ADDITIVE NEWLINE
;
...
:
   SET COMMUNITY communities += standard_community+ NEWLINE
;
