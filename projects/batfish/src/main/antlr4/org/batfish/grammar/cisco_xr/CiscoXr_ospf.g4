...
:
   REDISTRIBUTE (
      ...
      | ror_routing_instance_ospf_null
      | ror_routing_instance_rip_null
   )
;
...
ror_routing_instance_ospf_null
:
   OSPF null_rest_of_line
;
ror_routing_instance_rip_null
:
   RIP null_rest_of_line
;
...
rompls_traffic_eng: TRAFFIC_ENG ( rompls_traffic_eng_autoroute_exclude_null | rompls_traffic_eng_idp_sync_update_null | rompls_traffic_eng_igp_intact_null | rompls_traffic_eng_multicast_intact_null | rompls_traffic_eng_router_id_null );

rompls_traffic_eng_autoroute_exclude_null
:
   AUTOROUTE_EXCLUDE null_rest_of_line
;
rompls_traffic_eng_igp_intact_null
:
   IGP_INTACT null_rest_of_line
;
rompls_traffic_eng_idp_sync_update_null
:
   IDP_SYNC_UPDATE null_rest_of_line
;
rompls_traffic_eng_multicast_intact_null
:
   MULTICAST_INTACT null_rest_of_line
;
rompls_traffic_eng_router_id_null
:
   ROUTER_ID null_rest_of_line
;
