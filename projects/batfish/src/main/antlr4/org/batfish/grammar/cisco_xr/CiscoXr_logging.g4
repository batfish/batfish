...
:
  NO
  (
    ( logging_archive_archive_length_null | logging_archive_archive_size_null | logging_archive_device_null | logging_archive_file_size_null | logging_archive_frequency_null | logging_archive_severity_null | logging_archive_threshold_null )
  )
;
