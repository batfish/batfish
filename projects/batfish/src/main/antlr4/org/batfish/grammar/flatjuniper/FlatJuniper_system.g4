...
:
   ...
   (
      ...
      | syn_broadcast_null
      | syn_interval_range_null
      | syn_multicast_client_null
      | syn_nts_null
      | syn_peer_null
      | syn_restrict_null
      | syn_server
...
syn_interval_range_null
:
   INTERVAL_RANGE null_filler
;
syn_multicast_client_null
:
   MULTICAST_CLIENT null_filler
;
syn_nts_null
:
   NTS null_filler
...
syn_restrict_null
:
   RESTRICT null_filler
;
syn_threshold_null
:
   THRESHOLD null_filler
;
