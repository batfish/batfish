...
public enum CiscoStructureType implements StructureType {
  ...
  NAT_POOL("nat pool"),
  NESTED_ICMP_TYPE_OBJECT_GROUP("object-group group icmp-type"),
  NESTED_NETWORK_OBJECT_GROUP("object-group group network"),
  NESTED_PROTOCOL_OBJECT_GROUP("object-group group protocol"),
  NESTED_SERVICE_OBJECT_GROUP("object-group group service"),
