...
public class RoutingInformationBase implements Serializable {
  ...
  public RoutingInformationBase(@Nonnull String name) {
    ...
    // Attributes from this RIB's "static defaults" block, inherited by its static routes.
    _staticRouteDefaults = new StaticRouteV4(Prefix.ZERO);
    _staticRouteDefaultsV6 = new StaticRouteV6(Prefix6.ZERO);
  }
