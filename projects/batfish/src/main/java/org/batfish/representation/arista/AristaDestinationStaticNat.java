...
import static org.batfish.representation.arista.Conversions.nameOfDestNatIpSpaceFromAcl;
...
public final class AristaDestinationStaticNat implements Serializable {
  /** The protocol filter on the static destination NAT, if applicable. */
  ...
  private Transformation toTransformation(@Nullable Transformation orElse, boolean forward) {
    ...
    if (_extendedAclName != null) {
      IpSpace space = new IpSpaceReference(nameOfDestNatIpSpaceFromAcl(_extendedAclName));
