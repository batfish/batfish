...
public class ContainerInstance implements Serializable {
  ...
  public static class Port implements Serializable {
    ...
    public Port(
        @JsonProperty(AzureEntities.JSON_KEY_CONTAINER_INSTANCE_PORT_PROTOCOL) @Nullable
            IpProtocol protocol,
        @JsonProperty(AzureEntities.JSON_KEY_CONTAINER_INSTANCE_PORT_NUMBER) @Nullable
            Integer port) {
