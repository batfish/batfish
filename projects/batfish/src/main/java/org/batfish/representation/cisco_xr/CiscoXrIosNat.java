...
/**
 * Abstract class which represents any CiscoXr IOS NAT. NATs are {@link Comparable} to represent the
 * order in which they should be evaluated when converted to {@link Transformation}s.
 */
@ParametersAreNonnullByDefault
public abstract class CiscoXrIosNat implements Comparable<CiscoXrIosNat>, Serializable {
   ...
   */
  protected abstract int natCompare(CiscoXrIosNat other);

  @Override
  public final int compareTo(CiscoXrIosNat other) {
    return Comparator.comparingInt(CiscoXrIosNatUtil::getTypePrecedence)
