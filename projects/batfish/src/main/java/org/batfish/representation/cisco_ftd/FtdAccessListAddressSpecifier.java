...
/**
 * Represents an address specifier in an FTD access list line.
 * Supports: host, object, object-group, any, any4, any6, and network/mask
 * notation.
 */
public class FtdAccessListAddressSpecifier implements Serializable {
    ...
    public static FtdAccessListAddressSpecifier networkMask(Ip network, Ip mask) {
        FtdAccessListAddressSpecifier spec = new FtdAccessListAddressSpecifier(AddressType.NETWORK_MASK);
        spec._ip = network;
        spec._mask = mask;
        return spec;
    }
    ...
    public static FtdAccessListAddressSpecifier objectGroup(String objectGroupName) {
        FtdAccessListAddressSpecifier spec = new FtdAccessListAddressSpecifier(AddressType.OBJECT_GROUP);
