 ...
 */
public class BgpVrfAddressFamilyConfiguration implements Serializable {

  public BgpVrfAddressFamilyConfiguration() {
  ...
  private final Map<Prefix6, BgpVrfAddressFamilyAggregateNetworkConfiguration> _aggregateNetworks6;
