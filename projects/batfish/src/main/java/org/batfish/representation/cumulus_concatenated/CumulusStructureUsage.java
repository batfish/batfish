...
public enum CumulusStructureUsage implements StructureUsage {
  ...
  BGP_LISTEN_RANGE_SELF_REF(FrrStructureUsage.BGP_LISTEN_RANGE_SELF_REF),
  BGP_NEIGHBOR_INTERFACE(FrrStructureUsage.BGP_NEIGHBOR_INTERFACE),
  BGP_NEIGHBOR_INTERFACE_SELF_REF(FrrStructureUsage.BGP_NEIGHBOR_INTERFACE_SELF_REF),
  BGP_NEIGHBOR_SELF_REF(FrrStructureUsage.BGP_NEIGHBOR_SELF_REF),
  BGP_NETWORK(FrrStructureUsage.BGP_NETWORK),
  BGP_TABLE_MAP(FrrStructureUsage.BGP_TABLE_MAP),
