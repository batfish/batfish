...
public abstract class BgpPeerGroup implements Serializable {
  ...
  protected final BgpPeerGroup getParentGroup(BgpProcess proc, AsaConfiguration cv) {
  ...
  protected final BgpPeerGroup getParentSession(BgpProcess proc, AsaConfiguration cv) {
    BgpPeerGroup parent = null;
  ...
  public void inheritUnsetFields(BgpProcess proc, AsaConfiguration cv) {
    if (_inherited) {
      return;
    }
    _inherited = true;
