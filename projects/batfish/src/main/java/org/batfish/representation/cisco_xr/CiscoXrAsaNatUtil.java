...
/** Utility methods related to {@link CiscoXrAsaNat}. */
@ParametersAreNonnullByDefault
final class CiscoXrAsaNatUtil {
  private CiscoXrAsaNatUtil() {}
  ...
  static Boolean isIdentityObjectNat(
      CiscoXrAsaNat nat, Map<String, NetworkObject> networkObjects, Warnings w) {
  ...
  /**
   * Completes the conversion of CiscoXr ASA-specific NATs to a single {@link Transformation}.
   *
