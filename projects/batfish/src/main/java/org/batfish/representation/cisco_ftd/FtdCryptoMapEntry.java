...
/** Represents a single entry in a crypto map configuration */
public class FtdCryptoMapEntry implements Serializable {
  ...
  public FtdCryptoMapEntry(String name, int sequenceNumber) {
    _name = name;
