...
public class RoutingInstance implements Serializable {
  ...
  private @Nullable Integer _ospfExternalPreference;
  private @Nullable Integer _ospfPreference;
  ...
  public @Nullable Integer getOspfExternalPreference() {
    return _ospfExternalPreference;
  }

  public @Nullable Integer getOspfPreference() {
  ...
  public void setOspfExternalPreference(int ospfExternalPreference) {
    _ospfExternalPreference = ospfExternalPreference;
  }

  public void setOspfPreference(int ospfPreference) {
