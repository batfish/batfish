...
public class CiscoXrIosStaticNat extends CiscoXrIosNat {

  private Prefix _localNetwork;
  private Prefix _globalNetwork;

  @Override
  protected int natCompare(CiscoXrIosNat o) {
    if (!(o instanceof CiscoXrIosStaticNat)) {
      return 0;
    }
    CiscoXrIosStaticNat other = (CiscoXrIosStaticNat) o;
