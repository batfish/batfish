...
public abstract class BgpPeerGroup implements Serializable {
  ...
  protected final BgpPeerGroup getParentGroup(BgpProcess proc, CiscoXrConfiguration cv) {
  ...
  protected final BgpPeerGroup getParentSession(BgpProcess proc, CiscoXrConfiguration cv) {
    BgpPeerGroup parent = null;
  ...
  public void inheritUnsetFields(BgpProcess proc, CiscoXrConfiguration cv) {
    if (_inherited) {
      return;
    }
    _inherited = true;
