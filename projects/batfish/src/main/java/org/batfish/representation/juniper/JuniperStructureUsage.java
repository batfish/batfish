...
public enum JuniperStructureUsage implements StructureUsage {
  ...
  DOT1X_AUTHENTICATOR_INTERFACE("dot1x authenticator interface"),
  ...
  FIREWALL_FILTER_TERM_FILTER("firewall filter term filter"),
  ...
  IKE_POLICY_LOCAL_CERTIFICATE("ike policy local-certificate"),
  IKE_POLICY_IKE_PROPOSAL("ike policy ike proposal"),
  INTERFACE_ARP_POLICER("interface ARP policer"),
  ...
  INTERFACE_INPUT_POLICER("interface input policer"),
  ...
  INTERFACE_OUTPUT_POLICER("interface output policer"),
  ...
  MAC_VRF_VLAN_L3_INTERFACE("mac-vrf vlan l3-interface"),
  ...
  MPLS_LSP_PRIMARY_ADMIN_GROUP_EXCLUDE("mpls lsp primary admin-group exclude"),
  MPLS_LSP_PRIMARY_ADMIN_GROUP_INCLUDE_ALL("mpls lsp primary admin-group include-all"),
  MPLS_LSP_PRIMARY_ADMIN_GROUP_INCLUDE_ANY("mpls lsp primary admin-group include-any"),
  ...
  NAT_STATIC_RULE_THEN_ROUTING_INSTANCE("nat static rule then routing-instance"),
  ...
  OSPF3_RIB_GROUP("ospf3 rib-group"),
  ...
  ROUTING_OPTIONS_INSTANCE_EXPORT("routing-options instance-export"),
