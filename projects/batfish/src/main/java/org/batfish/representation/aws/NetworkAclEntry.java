...
public final class NetworkAclEntry implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return _isAllow == that._isAllow
        ...
        && Objects.equal(_cidrBlock, that._cidrBlock)
        && Objects.equal(_protocol, that._protocol)
        && Objects.equal(_portRange, that._portRange);
  }

  @Override
  public int hashCode() {
    return Objects.hashCode(_cidrBlock, _isAllow, _isEgress, _protocol, _ruleNumber, _portRange);
  }
