...
public class Abstraction {
  ...
  public ArrayList<Supplier<AbstractGraph>> equivalenceClasses() {
    ArrayList<Supplier<AbstractGraph>> classes = new ArrayList<>();
    for (Entry<Set<String>, Tuple<HeaderSpace, List<Prefix>>> entry : _headerspaceMap.entrySet()) {
      ...
      Supplier<AbstractGraph> sup =
          () -> AbstractGraphCreator.createGraph(this, devices, headerspace, prefixes);
      classes.add(sup);
    }
    return classes;
  }
  ...
  public int getPossibleFailures() {
    return _possibleFailures;
  }
}
