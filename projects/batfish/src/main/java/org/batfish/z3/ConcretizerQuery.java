...
public class ConcretizerQuery {
  ...
  public static final ConcretizerQuery UNSAT =
      new ConcretizerQuery(Collections.<Statement>singletonList(new UnsatExpr()));
  ...
  public static ConcretizerQuery blacklistDstIpQuery(Set<Ip> blacklistDstIps) {
    ...
    for (Ip blacklistDstIp : blacklistDstIps) {
      EqExpr hasBlacklistedDstIp =
          new EqExpr(new VarIntExpr(Synthesizer.DST_IP_VAR), new LitIntExpr(blacklistDstIp));
