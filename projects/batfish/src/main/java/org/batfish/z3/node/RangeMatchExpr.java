  ...
  public static BooleanExpr bitvectorGEExpr(String bv, long lb, int numBits) {
    ...
    while (numBitsLeft > 0) {
      ...
      if (orSpread >= 0) {
        ...
        IntExpr extractExpr = newExtractExpr(bv, numBits, orStartPos, orEndPos);
      ...
      if (andSpread >= 0) {
        ...
        LitIntExpr andMaskExpr = new LitIntExpr(andMask, andStartPos, andEndPos);
        IntExpr extractExpr = newExtractExpr(bv, numBits, andStartPos, andEndPos);
