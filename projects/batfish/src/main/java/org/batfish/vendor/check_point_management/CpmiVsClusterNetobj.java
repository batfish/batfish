...
public final class CpmiVsClusterNetobj extends GatewayOrServer {
  ...
  private static @Nonnull CpmiVsClusterNetobj create(
    ...
    return new CpmiVsClusterNetobj(ipv4Address, name, uid);
  }

  @VisibleForTesting
  CpmiVsClusterNetobj(Ip ipv4Address, String name, Uid uid) {
