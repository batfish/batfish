...
public class CheckpointNatConversions {
   ...
   * HasNatSettings}).
   */
  static boolean isValidAutomaticRule(
    ...
    1. A static rule. This is always represented in the rulebase by two rules with symmetric original src and dst:
       - Match from source addressSpaceFoo to destination Any
       - Match from source Any to destination addressSpaceFoo
