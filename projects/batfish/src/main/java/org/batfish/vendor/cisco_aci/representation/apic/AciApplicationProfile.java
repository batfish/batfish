...
/**
 * Data model class representing an ACI fvAp (Application Profile) object.
 *
 * <p>Application profiles are logical containers that group related endpoint groups (EPGs)
 * together. They provide a convenient way to organize EPGs that are logically related to one
 * another, such as by the application they provide (e.g., "web-app"), by function (e.g.,
 * "infrastructure"), or by location in the data center (e.g., "DMZ"). EPGs within an application
 * profile can communicate with each other and with EPGs in other application profiles based on
 * contract rules.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class AciApplicationProfile implements Serializable {

  @JsonProperty("attributes")
  private @Nullable AciApplicationProfileAttributes _attributes;

  @JsonProperty("children")
  private @Nullable List<Object> _children;

  public @Nullable AciApplicationProfileAttributes getAttributes() {
    return _attributes;
  }

  public void setAttributes(@Nullable AciApplicationProfileAttributes attributes) {
  ...
  /** Attributes of an ACI Application Profile (fvAp). */

  /** Attributes of an ACI Application Profile (fvAp). */
  @JsonInclude(JsonInclude.Include.NON_NULL)
  @JsonIgnoreProperties(ignoreUnknown = true)
  public static class AciApplicationProfileAttributes implements Serializable {
    ...
    private @Nullable String _hasMulticastSource;
    ...
    public @Nullable String getHasMulticastSource() {
      return _hasMulticastSource;
    }

    public void setHasMulticastSource(@Nullable String hasMulticastSource) {
      _hasMulticastSource = hasMulticastSource;
    }
