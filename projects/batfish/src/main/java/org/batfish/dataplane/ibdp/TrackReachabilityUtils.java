...
public final class TrackReachabilityUtils {
  ...
  /**
   * Returns the potential source IPs corresponding originating VRFs of a flow with the given {@code
   * dstIp} originating on the given {@link Configuration} with the given {@code fibs} indexed by
   * vrf, to be resolved in the given {@code initialSenderVrf}, Concretely, finds LPM routes for
   * {@code dstIp} and returns the IPs and VRFsof those routes' forwarding interfaces.
   */
