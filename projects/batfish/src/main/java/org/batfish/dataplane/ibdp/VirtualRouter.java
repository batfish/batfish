...
public class VirtualRouter implements Serializable {
   ...
   * configuration)
   */
  private transient SortedMap<CrossVrfEdgeId, Queue<RouteAdvertisement<EvpnRoute>>>
      _crossVrfIncomingEvpnRoutes;
  ...
  /** Incoming messages into this router from each EVPN neighbor */
  transient SortedMap<EdgeId, Queue<RouteAdvertisement<EvpnRoute>>> _evpnIncomingRoutes;
