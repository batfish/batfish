...
public class Driver {
  ...
  private static boolean registerWithCoordinator(String poolRegUrl) {
    ...
    params.put(CoordConsts.SVC_KEY_ADD_WORKER,
  ...
  public static Object talkToCoordinator(String url, Map<String, String> params,
    ...
    try {
      ...
      logger.debug("BF: " + response.getStatus() + " " + response.getStatusInfo()
              + " " + response + "\n");
