...
public class CiscoControlPlaneSensitiveDataCollector extends
      CiscoParserBaseListener {
   ...
   public CiscoControlPlaneSensitiveDataCollector(
         Map<String, String> variableMap, Set<Ip> ipAddresses) {
    ...
    * CiscoCommonLexer.VARIABLE: addVariable(symbol.getText()); break; case
    * CiscoCommonLexer.IP_ADDRESS: Ip ip = new Ip(symbol.getText());
    * _ipAddresses.add(ip); break; default: break; } }
    */
    ...
    * Null_standalone_if_stanzaContext ctx) { // TODO Auto-generated method stub
    * }
    * @Override public void enterBanner_stanza(Banner_stanzaContext ctx) { //
    * TODO Auto-generated method stub }
