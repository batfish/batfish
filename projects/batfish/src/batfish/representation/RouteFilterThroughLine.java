...
public class RouteFilterThroughLine extends RouteFilterLine {
   ...
   public String getIFString(int indentLevel) {
      String retString = Util.getIndentString(indentLevel)
            + String
                  .format(
                        "RouteFilterThroughLine Prefix %s PrefixLength %s SecondPrefix %s SecondPrefixLength %s Action %s",
                        _prefix, _prefixLength, _secondPrefix,
                        _secondPrefixLength, getAction());
      return retString;
   }
   ...
   public boolean sameParseTree(RouteFilterLine line) {
      ...
      return (getAction() == rhs.getAction()) && (_prefix.equals(rhs._prefix))
            ...
            && (_secondPrefix.equals(rhs._secondPrefix))
            && (_secondPrefixLength == rhs._secondPrefixLength);
