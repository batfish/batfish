...
public final class PaloAltoGrammarTest {
  ...
  public void testAddressGroups() {
    ...
    // we parsed the description and tag, addr3 is undefined but should not have
    // been discarded
    ...
    // check that we parse multiple address objects and tags on the same line
    // correctly
    assertThat(
  ...
  public void testAddressGroupDynamic() {
    ...
    // Confirm the filter resolves to the correct IpSpace, containing only the one
    // matching address
    assertThat(
  ...
  public void testAddressObjects() {
    ...
    // check that we parse normal object names, names with spaces, and that look
    // like IP addresses
    assertThat(
  ...
  public void testAddressObjectReference() throws IOException {
    ...
    // Should record reference for address object name that looks like a concrete IP
    // address
    assertThat(
  ...
  public void testBgpExportImportPolicyConversion() {
    ...
    // test the routing policy generated by for all export policy rules used by this
    // peer
    ...
    // testing the combined routing policy generated for the peer (conjunction of
    // above two
    // policies)
  ...
  public void testApplicationsBuiltinReference() throws IOException {
    ...
    // Confirm reference count is correct for defined structure that overwrites
    // builtin
  ...
  public void testInterfaceConversion() {
    ...
    // Confirm addresses are extracted, even when specified as address-object
    // reference
    assertThat(
        c,
        hasInterface(
    ...
    // From ambiguous address object reference (object name looks like an IP
    // address)
    assertThat(
        c,
        hasInterface(
    ...
    // Confirm loopback addresses are extracted, even when specified as
  ...
  public void testNestedConfigLineComments() throws IOException {
    ...
    // Confirm extraction works for nested configs even in the presence of line
    // comments
    assertThat(parseTextConfigs(hostname).keySet(), contains(hostname));
  }
  ...
  public void testLineMapMultilineToken() {
    ...
    /*
     * Sanity check; make sure flattening produces the line we expect, where we
     * expect them
     */
    ...
    /*
     * Confirm original line numbers are preserved thru map, note line number here
     * starts from 1
     */
    ...
    /*
     * Start, middle, and end lines in a multiline token should be mapped to public
     * key line
     */
    assertThat(
  ...
  public void testNestedConfigStructureDef() throws IOException {
    ...
    // Confirm defined structures in nested config show up with original definition
    // line numbers
    assertThat(
        ccae,
  ...
  public void testRulebase() {
    ...
    // Confirm intrazone flow not matching allow rule (bad destination address) is
    // rejected
    assertThat(
        c,
        hasInterface(
    ...
    // Confirm intrazone flow not matching allow rule (source address negated) is
    // rejected
    assertThat(
        c,
        hasInterface(
  ...
  public void testSecurityRulesNotExplicitlyMatched() {
    /*
     * Setup: Device has an interface in a zone with intrazone security rules. If
     * flows leaving the
     * interface match an intrazone rule, its action should be taken (whether permit
     * or deny). Other
    ...
    // Flow is from interface inside the zone and is permitted by zone security
    // rules
  ...
  public void testIfaceOutgoingFilterTraceElements() {
    // Device has an interface in the zone. Ensure that outgoing filter lines have
    // expected trace
    ...
    // Flow that does not match either security rule should fall through to
    // intrazone default
    ...
    // Flow matching DENY security rule should generate a trace pointing to that
    // rule.
    flowTrace =
        AclTracer.trace(
            ifaceOutgoingFilter,
    ...
    // Flow matching PERMIT security rule should generate a trace pointing to that
    // rule.
    flowTrace =
        AclTracer.trace(
            ifaceOutgoingFilter,
  ...
  public void testUnzonedIfaceOutgoingFilterTraceElements() {
    // Device has an interface without a zone; its outgoing filter should reflect
    // that
    String hostname = "security-no-explicit-match";
    Configuration c = parseConfig(hostname);
    String ifaceName = "ethernet1/1";

    // This ACL has an unnecessary (unreachable) second line; no need to assert on
    // that line
    IpAccessList ifaceOutgoingFilter =
        c.getIpAccessLists().get(computeOutgoingFilterName(ifaceName));
    assertThat(
  ...
  public void testEmptyZoneOutgoingFilterTraceElements() {
    // Device has a zone without any interfaces; intra- and cross-zone filters
    // should reflect that
    String hostname = "security-no-explicit-match";
    Configuration c = parseConfig(hostname);
    String vsysName = "vsys1";
  ...
  public void testRulebaseRuleType() {
    ...
    // the intrazone line should have been rejected -- which leaves this rule as
    // default
  ...
  public void testStaticRoute() throws IOException {
    ...
    // static-route with next-vr same as its own virtual-router should not be
    // converted
    assertThat(
  ...
  public void testService() {
    ...
    // Confirm service-group SG1 accepts flows matching its member definitions and
    // rejects others
    ...
    // Confirm SG2 accepts flows matching its member's member definitions and
    // rejects others
  ...
  public void testServiceBuiltinReference() throws IOException {
    ...
    // Confirm built-ins that are not overridden are not considered defined
    // structures
  ...
  public void testServiceBuiltinOverride() {
    ...
    // Confirm HTTPS service group accepts flows matching overridden HTTPS
    // definition only
    assertThat(
    ...
    // Confirm HTTP service group accepts flows matching overridden HTTP definition
    // only
    assertThat(
  ...
  public void testSharedGatewayReference() throws IOException {
    ...
    // Confirm structure definitions are recorded correctly, even for badly named
    // shared-gateway
    ...
    // Confirm the undefined interface is properly detected as an undefined
    // reference
  ...
  public void testVsysService() {
    ...
    // Confirm group in vsys1 namespace references its own service, not shared or
    // neighbor services
    ...
    // Confirm group in vsys2 namespace references its own service, not shared or
    // neighbor services
    ...
    // Confirm group in shared namespace references its own service, not vsys
    // specific services
  ...
  public void testZoneExternal() {
    ...
    // Make sure the external zones are correctly populated with the specified
    // external names
  ...
  public void testDeviceGroupConversion() {
    ...
    // First two firewalls should inherit definitions from first Panorama
    // device-group
    assertIpSpacesEqual(
  ...
  public void testTemplateStackOverwriteConversion() {
    ...
    // Only SG1 servers and shared servers from template 1 should make it into VI
    // model
    assertThat(
        firewall1.getLoggingServers(),
        contains("10.1.21.1", "10.1.23.1", "10.1.31.1", "10.1.33.1"));
    // Primary dns / ntp servers should be overwritten by T1, but secondary should
    // come from T2
  ...
  public void testDeviceGroupSharedInheritanceVSIDs() {
    ...
    // Security rule from Panorama vsys has the correct VSID (pointing to Panorama
    // vsys)
  ...
  public void testDeviceGroupSharedInerhitance() {
    ...
    // Address only defined in device-group or shared namespace should directly end
    // up in VI config
    assertIpSpacesEqual(
    ...
    // Address defined in both device-group and shared namespace should have
    // definition from
  ...
  public void testPanoramaWarning() throws IOException {
    ...
    // Should have a warning about an unknown application associated with the
    // firewall
  ...
  public void testDeviceGroupAttachVsysConversion() {
    ...
    // Should get the panorama and firewall VI configs from the single panorama VS
    // config
    assertThat(
        viConfigs.stream().map(Configuration::getHostname).collect(Collectors.toList()),
        containsInAnyOrder(panoramaHostname, firewallId1));
  ...
  public void testInterfaceRuntimeAddressConversion() throws IOException {
    ...
    // For interfaces without configured address, address should be pulled from
    // runtime data
    assertThat(
  ...
  public void testApplicationOverrideRuleDiffVsysVSIDs() {
    ...
    // Arbitrarily choose one zone pair to test (rule should be applied to all zone
    // pairs)
    IpAccessList z1ToZ2Filter =
        firewall1
            .getIpAccessLists()
    ...
    // Even though it is in a different vsys (Panorama) than the interfaces/zones
    // (vsys1)
    assertThat(
        flowTraceRULE1,
        contains(
  ...
  // TODO: remove fake interfaces "vlan" and "tunnel" and associated bind
  // dependencies
  ...
  @Test
  public void testSourceUser() {
    PaloAltoConfiguration c = parsePaloAltoConfig("source-user-warning");
    Vsys vsys = c.getVirtualSystems().get(DEFAULT_VSYS_NAME);
    SecurityRule rule = vsys.getRulebase().getSecurityRules().get("r1");

    assertThat(rule.getSourceUsers(), containsInAnyOrder("user1", "user2"));
  }

  @Test
  public void testHipFields() {
    PaloAltoConfiguration c = parsePaloAltoConfig("hip-warning");
    Vsys vsys = c.getVirtualSystems().get(DEFAULT_VSYS_NAME);
    SecurityRule rule = vsys.getRulebase().getSecurityRules().get("rule1");
