...
public final class PaloAltoGrammarTest {
  ...
  @Test
  public void testBgpExportPolicyConversion() {
    ...
    RoutingPolicy rdpRoutingPolicy = c.getRoutingPolicies().get(bgpCommonExportPolicyName);
    ...
    boolean accepted = rdpRoutingPolicy.process(srb.build(), bgpBuilder, Direction.OUT);
    assertTrue(accepted);
    ...
    // test the routing policy generated by the export policy rule
    String bgpExportPolicyRuleRoutingPolicyName = "~BGP_POLICY_RULE_EXPORT_POLICY:vr1:export1";
