...
import org.batfish.datamodel.matchers.AclIpSpaceMatchers;
...
public class FlatJuniperGrammarTest {
  ...
  public void testNatSource() throws IOException {
    ...
    FilterResult fr = nat1.getAcl().filter(flow1, "ge-0/0/0.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr.getAction(), equalTo(LineAction.PERMIT));

    FilterResult fr2 = nat1.getAcl().filter(flow1, "ge-0/0/1.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr2.getAction(), equalTo(LineAction.DENY));

    FilterResult fr3 = nat1.getAcl().filter(flow2, "ge-0/0/0.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr3.getAction(), equalTo(LineAction.DENY));

    FilterResult fr4 = nat1.getAcl().filter(flow2, "ge-0/0/1.0", config.getIpAccessLists(), config.getIpSpaces());
    ...
    fr2 = nat2.getAcl().filter(flow1, "ge-0/0/1.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr2.getAction(), equalTo(LineAction.DENY));

    fr3 = nat2.getAcl().filter(flow2, "ge-0/0/0.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr3.getAction(), equalTo(LineAction.PERMIT));

    fr4 = nat2.getAcl().filter(flow2, "ge-0/0/1.0", config.getIpAccessLists(), config.getIpSpaces());
    assertThat(fr4.getAction(), equalTo(LineAction.DENY));
