...
public final class FlatJuniperGrammarTest {
  ...
  public void testRiskyTerminalTermsInPolicyStatements() throws IOException {
    ...
    assertThat("Should have exactly 2 RISKY warnings", riskyWarnings, hasSize(2));

    String expectedRiskyRejectWarning =
        "RISK: Policy statement 'RISKY-REJECT' term 'UNCONDITIONAL-REJECT' contains unconditional"
            + " terminal action that makes 2 subsequent term(s) unreachable: UNREACHABLE-TERM1,"
            + " UNREACHABLE-TERM2";
    assertThat(
    ...
    String expectedRiskyAcceptWarning =
        "RISK: Policy statement 'RISKY-ACCEPT' term 'UNCONDITIONAL-ACCEPT' contains unconditional"
            + " terminal action that makes 1 subsequent term(s) unreachable: UNREACHABLE-TERM";
    assertThat(
