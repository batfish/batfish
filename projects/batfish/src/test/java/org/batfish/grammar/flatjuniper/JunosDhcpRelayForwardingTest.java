...
public final class JunosDhcpRelayForwardingTest {

  private static final String HOSTNAME = "junos-dhcp-relay-forwarding";

  @Rule public TemporaryFolder _folder = new TemporaryFolder();

  @Test
  public void testDhcpRelayForwarding() throws IOException {
