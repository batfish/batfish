...
import org.batfish.representation.cisco_ftd.FtdAccessListAddressSpecifier.AddressType;
import org.batfish.representation.cisco_ftd.FtdAccessListLine;
import org.batfish.representation.cisco_ftd.FtdAccessListLine.AclType;
...
public class FtdAccessListTest extends FtdGrammarTest {
  ...
  public void testAclWithMultipleOptions() {
    String config = "access-list ACL1 extended permit ip any any rule-id 100 log time-range WORK_HOURS\n";
  ...
  public void testPrefilterPolicyAclLines() {
    String config = join(
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE any object-group OBJ_GRP1 object-group OBJ_GRP2 rule-id 100 event-log flow-end",
        "access-list TEST_ACL remark rule-id 100: PREFILTER POLICY: TEST_POLICY",
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE object-group OBJ_GRP3 object-group OBJ_GRP4 eq domain rule-id 200 event-log flow-end");
    ...
    assertThat(
        remarkLine.getRemark(),
        equalTo("rule-id 100: PREFILTER POLICY: TEST_POLICY"));
  }
  ...
  public void testPrefilterPolicyRemarksAndEventLog() {
    String config = join(
        ...
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE any any eq domain rule-id 300 event-log flow-end",
        "access-list TEST_ACL advanced trust udp ifc OUTSIDE any any eq domain rule-id 300 event-log flow-start");
    ...
    assertThat(
        policyRemark.getRemark(),
        equalTo("rule-id 300: PREFILTER POLICY: TEST_POLICY"));
  ...
  public void testPrefilterObjectGroupServicePortsAndRanges() {
    String config = join(
        ...
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE object-group OBJ_GRP1 object-group TCP_22 rule-id 400 event-log flow-end",
        "access-list TEST_ACL advanced trust udp ifc OUTSIDE object-group OBJ_GRP1 object-group UDP_161 rule-id 400 event-log flow-end",
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE host 192.0.2.1 host 192.0.2.2 range 5000 5001 rule-id 500",
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE host 192.0.2.1 host 192.0.2.2 range 7011 7025 rule-id 500");
    ...
    assertThat(
        policyRemark.getRemark(),
        equalTo("rule-id 400: PREFILTER POLICY: TEST_POLICY"));

    FtdAccessListLine firstRule = acl.getLines().get(2);
    assertThat(firstRule.getAction(), equalTo(LineAction.PERMIT));
    assertThat(firstRule.getDestinationAddressSpecifier().getType(), equalTo(AddressType.OBJECT_GROUP));
  ...
  public void testPrefilterMixedServiceSpecsSharedRuleId() {
    String config = join(
        ...
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE object-group OBJ_GRP1 object OBJ1 object-group TCP-6974 rule-id 600 event-log flow-end",
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE object-group OBJ_GRP1 object OBJ1 eq https rule-id 600 event-log flow-end",
        "access-list TEST_ACL advanced trust tcp ifc OUTSIDE object-group OBJ_GRP1 object OBJ1 range 6977 6979 rule-id 600 event-log flow-end");
    ...
    assertThat(
        policyRemark.getRemark(),
        equalTo("rule-id 600: PREFILTER POLICY: TEST_POLICY"));

    FtdAccessListLine objectGroupRule = acl.getLines().get(2);
    assertThat(objectGroupRule.getAction(), equalTo(LineAction.PERMIT));
    assertThat(objectGroupRule.getDestinationAddressSpecifier().getType(), equalTo(AddressType.OBJECT));
  ...
  public void testPrefilterAny4Any6AndEventLogVariants() {
    String config = join(
        ...
        "access-list TEST_ACL advanced trust icmp ifc OUTSIDE any4 any4 rule-id 700 event-log flow-nsel",
        "access-list TEST_ACL advanced trust icmp ifc OUTSIDE any6 any6 rule-id 700 event-log flow-start");
  ...
  public void testPrefilterDenyWithAnyAndIpProtocol() {
    String config = join(
        ...
        "access-list TEST_ACL advanced deny ip ifc OUTSIDE any any rule-id 800 event-log flow-end");
