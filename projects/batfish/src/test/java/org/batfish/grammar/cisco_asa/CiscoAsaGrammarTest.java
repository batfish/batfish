...
import static org.batfish.representation.cisco_asa.AsaConfiguration.computeCombinedOutgoingAclName;
import static org.batfish.representation.cisco_asa.AsaConfiguration.computeIcmpObjectGroupAclName;
import static org.batfish.representation.cisco_asa.AsaConfiguration.computeInspectClassMapAclName;
import static org.batfish.representation.cisco_asa.AsaConfiguration.computeInspectPolicyMapAclName;
...
import static org.batfish.representation.cisco_asa.AsaConfiguration.computeZonePairAclName;
import static org.batfish.representation.cisco_asa.AsaConfiguration.eigrpNeighborExportPolicyName;
import static org.batfish.representation.cisco_asa.AsaConfiguration.eigrpNeighborImportPolicyName;
import static org.batfish.representation.cisco_asa.CiscoConversions.computeVrfExportImportPolicyName;
import static org.batfish.representation.cisco_asa.CiscoIosDynamicNat.computeDynamicDestinationNatAclName;
...
public final class CiscoAsaGrammarTest {
  ...
  public void testIosInspection() throws IOException {
    ...
    String zone2OutgoingAclName = AsaConfiguration.computeZoneOutgoingAclName(zone2Name);
  ...
  public void testIosOspfDistributeList() {
    ...
    org.batfish.representation.cisco_asa.OspfProcess ospfProcessPrefix =
    ...
    org.batfish.representation.cisco_asa.OspfProcess ospfProcessRouteMap =
    ...
    org.batfish.representation.cisco_asa.OspfProcess ospfProcessAcl =
  ...
  public void testIosVrfDefinition() {
    ...
    {
      org.batfish.representation.cisco_asa.Vrf vrf = vc.getVrfs().get("vrf2");
  ...
  public void testBgpReentrantVrf() {
    ...
    org.batfish.representation.cisco_asa.BgpProcess vrfBgp = c.getVrfs().get("a").getBgpProcess();
  ...
  public void testOspfMaxMetric() throws IOException {
    ...
    long expectedMaxMetricRouterLsa =
        org.batfish.representation.cisco_asa.OspfProcess.MAX_METRIC_ROUTER_LSA;
    long expectedMaxMetricStub =
        org.batfish.representation.cisco_asa.OspfProcess.MAX_METRIC_ROUTER_LSA;
    long expectedMaxMetricExternal =
        org.batfish.representation.cisco_asa.OspfProcess.DEFAULT_MAX_METRIC_EXTERNAL_LSA;
    long expectedMaxMetricSummary =
        org.batfish.representation.cisco_asa.OspfProcess.DEFAULT_MAX_METRIC_SUMMARY_LSA;
  ...
  public void testIosDynamicNatExtraction() throws IOException {
    AsaConfiguration c = parseCiscoConfig("ios-nat-dynamic", ConfigurationFormat.CISCO_IOS);
