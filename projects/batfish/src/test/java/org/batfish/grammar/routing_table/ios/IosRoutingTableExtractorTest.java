...
public final class IosRoutingTableExtractorTest {
  ...
  private RoutesByVrf testNextHop_RoutesByVrf() throws IOException {
    ...
    String showIpRoute =
        CommonUtil.readResource("org/batfish/grammar/routing_table/ios/test_next_hop.txt");

    IosRoutingTableCombinedParser parser = new IosRoutingTableCombinedParser(showIpRoute, settings);
    IosRoutingTableExtractor extractor =
        new IosRoutingTableExtractor("hostname", showIpRoute, parser, warnings, batfish);
