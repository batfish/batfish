...
public final class JunosBgpErrorToleranceTest {
  ...
  public void testErrorTolerance() throws IOException {
    ...
    assertThat(
        ...
        contains(
            isTodo("bgp-error-tolerance"),
            isTodo("bgp-error-tolerance malformed-route-limit 20"),
            isTodo("bgp-error-tolerance malformed-update-log-interval 300"),
            isTodo("bgp-error-tolerance no-malformed-route-limit")));
  }
}
