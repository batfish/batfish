...
public final class JunosPolicyDampingTest {
  ...
  public void testProfileExtractionAndReferences() throws IOException {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            ...
            isTodo("damping CONSERVATIVE"),
            isTodo("damping UNDEFINED")));
  ...
  public void testRouteFilterAction() throws IOException {
    ...
    assertThat(getParseWarnings(batfish, ROUTE_FILTER_DAMPING), contains(isTodo("damping TIMID")));
    assertThat(
  ...
  public void testNoneAction() throws IOException {
    ...
    assertThat(getParseWarnings(batfish, THEN_DAMPING), contains(isTodo("damping conservative")));
