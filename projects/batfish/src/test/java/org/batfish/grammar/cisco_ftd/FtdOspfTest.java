...
public class FtdOspfTest extends FtdGrammarTest {
  ...
  private static final String NETWORK_192_168_1_0_AREA_0 = "  network 192.168.1.0 255.255.255.0 area 0";
  ...
  private static final String NETWORK_192_168_2_0_AREA_0 = "  network 192.168.2.0 255.255.255.0 area 0";
  ...
  public void testOspfDifferentAreas() {
    ...
    long areaCount = ospf.getNetworks().stream()
        .mapToLong(FtdOspfNetwork::getAreaId)
        .distinct()
        .count();
  ...
  public void testOspfWithLargeAreaNumber() {
    String config = join(
        ROUTER_OSPF_100,
        "  network 192.168.1.0 255.255.255.0 area 100");
