...
public class AzureConfigurationTest {
    ...
    public void testAzureConfiguration_addConfigElement() throws IOException {
        ...
        azureConfiguration.addConfigElement(node, "publicIp", new ParseVendorConfigurationAnswerElement());

        assertNotNull(
                azureConfiguration
                        .addOrGetRegion("westeurope")
    ...
    public void testToVendorConfigurations_ispConfiguration() throws IOException {
        ...
        azureConfiguration.addConfigElement(node2, "testIp", new ParseVendorConfigurationAnswerElement());
        ...
        assertEquals(
                List.of(new IspNodeInfo(
                        AzureConfiguration.AZURE_BACKBONE_ASN, AzureConfiguration.AZURE_BACKBONE_HUMAN_NAME,
