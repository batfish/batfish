...
public class PsThensTest {
  ...
  public void testOriginDedup() {
    ...
    assertEquals(ImmutableSet.of(igp), ps.getAllThens());
  }
  ...
  public void testOriginLastWins() {
    ...
    assertEquals(ImmutableSet.of(egp), ps.getAllThens());
  }
  ...
  public void testPreferenceDedup() {
    ...
    assertEquals(ImmutableSet.of(pref), ps.getAllThens());
  }
  ...
  public void testPreferenceLastWins() {
    ...
    assertEquals(ImmutableSet.of(p200), ps.getAllThens());
  }
  ...
  public void testTagDedup() {
    ...
    assertEquals(ImmutableSet.of(tag), ps.getAllThens());
  }
  ...
  public void testTagLastWins() {
    ...
    assertEquals(ImmutableSet.of(t200), ps.getAllThens());
  }
  ...
  public void testNextHopIpDedup() {
    ...
    assertEquals(ImmutableSet.of(nh), ps.getAllThens());
  }
  ...
  public void testNextHopIpLastWins() {
    ...
    assertEquals(ImmutableSet.of(nh2), ps.getAllThens());
  }
  ...
  public void testNextHopSelfVsIp() {
    ...
    assertEquals(ImmutableSet.of(nhIp), ps.getAllThens());
  }
  ...
  public void testNextHopSelfVsPeer() {
    ...
    assertEquals(ImmutableSet.of(PsThenNextHopPeerAddress.INSTANCE), ps.getAllThens());
  }
  ...
  public void testNextHopRejectVsDiscard() {
    ...
    assertEquals(ImmutableSet.of(PsThenNextHopDiscard.INSTANCE), ps.getAllThens());
  }
  ...
  public void testExternalDedup() {
    ...
    assertEquals(ImmutableSet.of(e1), ps.getAllThens());
  }
  ...
  public void testExternalLastWins() {
    ...
    assertEquals(ImmutableSet.of(e2), ps.getAllThens());
  }
  ...
  public void testLoadBalanceLastWins() {
    ...
    assertEquals(ImmutableSet.of(consistentHash), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceSetDiff() {
    ...
    assertEquals(ImmutableSet.of(lp50), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceSetSame() {
    ...
    assertEquals(ImmutableSet.of(lp), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceSetThenAdd() {
    ...
    assertEquals(ImmutableSet.of(lpAdd), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceAddThenSet() {
    ...
    assertEquals(ImmutableSet.of(lpSet), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceSetThenSubtract() {
    ...
    assertEquals(ImmutableSet.of(lpSub), ps.getAllThens());
  }
  ...
  public void testLocalPreferenceAddDiff() {
    ...
    assertEquals(ImmutableSet.of(lpAdd50), ps.getAllThens());
  }
  ...
  public void testMetricSetDiff() {
    ...
    assertEquals(ImmutableSet.of(m50), ps.getAllThens());
  }
  ...
  public void testMetricSetSame() {
    ...
    assertEquals(ImmutableSet.of(m), ps.getAllThens());
  }
  ...
  public void testMetricSetThenAdd() {
    ...
    assertEquals(ImmutableSet.of(mAdd), ps.getAllThens());
  }
  ...
  public void testMetricAddThenSet() {
    ...
    assertEquals(ImmutableSet.of(mSet), ps.getAllThens());
  }
  ...
  public void testMetricAddDiff() {
    ...
    assertEquals(ImmutableSet.of(mAdd50), ps.getAllThens());
  }
  ...
  public void testMetricAddThenSubtract() {
    ...
    assertEquals(ImmutableSet.of(mSub), ps.getAllThens());
  }
  ...
  public void testPrependLastWins() {
    ...
    assertEquals(ImmutableSet.of(p2), ps.getAllThens());
  }
  ...
  public void testPrependMultiVsSingle() {
    ...
    assertEquals(ImmutableSet.of(single), ps.getAllThens());
  }
  ...
  public void testPrependAndExpandBothRetained() {
    ...
    assertEquals(ImmutableSet.of(prepend, expand), ps.getAllThens());
  }
  ...
  public void testExpandAndPrependBothRetained() {
    ...
    assertThat(ps.addPsThen(expand), empty());
    assertThat(ps.addPsThen(prepend), empty());
    assertEquals(ImmutableSet.of(expand, prepend), ps.getAllThens());
  }
  ...
  public void testExpandLastAsLastWins() {
    ...
    assertEquals(ImmutableSet.of(e3), ps.getAllThens());
  }
  ...
  public void testCommunityAddDedup() {
    // add RED; add RED — second is exact duplicate
    PsThens ps = new PsThens();
    PsThenCommunityAdd red = new PsThenCommunityAdd("RED");
    assertThat(ps.addPsThen(red), empty());
    assertThat(ps.addPsThen(new PsThenCommunityAdd("RED")), contains("community add RED (dedup)"));
    assertEquals(ImmutableSet.of(red), ps.getAllThens());
  }
  ...
  public void testCommunityDeleteDedup() {
    ...
    assertEquals(ImmutableSet.of(delRed), ps.getAllThens());
  }
  ...
  public void testCommunityAddThenSetWipesAdd() {
    ...
    assertEquals(ImmutableSet.of(setBlue), ps.getAllThens());
  }
  ...
  public void testCommunitySetThenSetDedup() {
    ...
    assertEquals(ImmutableSet.of(setRed), ps.getAllThens());
  }
  ...
  public void testCommunitySetWipesAllPrior() {
    ...
    assertEquals(ImmutableSet.of(setGreen), ps.getAllThens());
  }
  ...
  public void testLoadBalanceDedup() {
    ...
    assertEquals(ImmutableSet.of(lb), ps.getAllThens());
  }
  ...
  // ==========================================================================
  // Tunnel-attribute — cumulative (different names retained)
  // ==========================================================================
  ...
  public void testTunnelAttributeSetDedup() {
    ...
    assertEquals(ImmutableSet.of(ta1), ps.getAllThens());
  }

  @Test
  public void testTunnelAttributeSetDifferentBothRetained() {
    PsThens ps = new PsThens();
    PsThenTunnelAttributeSet ta1 = new PsThenTunnelAttributeSet("ta1");
    PsThenTunnelAttributeSet ta2 = new PsThenTunnelAttributeSet("ta2");
    assertThat(ps.addPsThen(ta1), empty());
    assertThat(ps.addPsThen(ta2), empty());
    assertThat(ps.getAllThens(), containsInAnyOrder(ta1, ta2));
  }
  ...
  public void testAcceptThenRejectLastWins() {
    ...
    assertThat(ps.addPsThen(PsThenReject.INSTANCE), contains("bare-terminator"));
    assertEquals(ImmutableSet.of(PsThenReject.INSTANCE), ps.getAllThens());
  }
  ...
  public void testRejectThenAcceptLastWins() {
    ...
    assertThat(ps.addPsThen(PsThenAccept.INSTANCE), contains("bare-terminator"));
    assertEquals(ImmutableSet.of(PsThenAccept.INSTANCE), ps.getAllThens());
  }
  ...
  public void testAcceptDedup() {
    PsThens ps = new PsThens();
    assertThat(ps.addPsThen(PsThenAccept.INSTANCE), empty());
    assertThat(ps.addPsThen(PsThenAccept.INSTANCE), contains("bare-terminator (dedup)"));
    assertEquals(ImmutableSet.of(PsThenAccept.INSTANCE), ps.getAllThens());
  }
  ...
  public void testAcceptThenNextTermSuppresses() {
    // accept; next term — both retained at commit; runtime falls through. Adding next-term
    // after a bare terminator emits a "suppressed-by-next-term" warning.
    PsThens ps = new PsThens();
    assertThat(ps.addPsThen(PsThenAccept.INSTANCE), empty());
    assertThat(
        ps.addPsThen(PsThenNextTerm.INSTANCE),
        contains("bare-terminator (suppressed-by-next-term)"));
    assertThat(
  ...
  public void testNextTermThenAcceptIsDead() {
    // next term; accept — accept after next-term is dead config. Different message.
    PsThens ps = new PsThens();
    assertThat(ps.addPsThen(PsThenNextTerm.INSTANCE), empty());
    assertThat(
        ps.addPsThen(PsThenAccept.INSTANCE), contains("bare-terminator (dead-after-next-term)"));
    assertThat(
        ps.getAllThens(), containsInAnyOrder(PsThenAccept.INSTANCE, PsThenNextTerm.INSTANCE));
  }
  ...
  public void testNextTermDedup() {
    PsThens ps = new PsThens();
    assertThat(ps.addPsThen(PsThenNextTerm.INSTANCE), empty());
    // PsThenNextTerm is a singleton so it dedups via reference equality
    assertThat(ps.addPsThen(PsThenNextTerm.INSTANCE), contains("next-term (dedup)"));
    assertEquals(ImmutableSet.of(PsThenNextTerm.INSTANCE), ps.getAllThens());
  }
}
