...
public class AsaConversionsTest {
  ...
  public void testToRouterFilterList_extendedAccessList_source() {
    ...
    assertThat(
        rfl.getSourceType(), equalTo(AsaStructureType.IPV4_ACCESS_LIST_EXTENDED.getDescription()));
  }
  ...
  public void testToRouterFilterList_standardAccessList_source() {
    ...
    assertThat(rfl.getSourceName(), equalTo("name"));
    assertThat(
        rfl.getSourceType(), equalTo(AsaStructureType.IPV4_ACCESS_LIST_STANDARD.getDescription()));
  }
  ...
  public void testToRouterFilterList_prefixList_source() {
    ...
    assertThat(rfl.getSourceName(), equalTo("name"));
    assertThat(rfl.getSourceType(), equalTo(AsaStructureType.PREFIX_LIST.getDescription()));
  }
}
