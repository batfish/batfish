...
public class PsFromPrefixListFilterLongerTest {
  ...
  public void toBooleanExpr() {
    ...
    PsFromPrefixListFilterLonger expr = new PsFromPrefixListFilterLonger(pl.getName());
    ...
    assertThat(converted.permits(Prefix.parse("1.2.3.4/32")), equalTo(false));
    ...
    assertThat(converted.permits(Prefix.parse("2.0.0.0/8")), equalTo(false));
