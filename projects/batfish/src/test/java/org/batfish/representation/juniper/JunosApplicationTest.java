...
public class JunosApplicationTest {
  ...
  public void testToAclLineMatchExpr_bgp() {
    assertEquals(
        JunosApplication.JUNOS_BGP.toAclLineMatchExpr(null, null),
        new OrMatchExpr(
            ImmutableList.of(
  ...
  public void testToAclLineMatchExpr_smb() {
    ...
    assertEquals(
        JunosApplication.JUNOS_SMB.toAclLineMatchExpr(null, null),
        new OrMatchExpr(
            ImmutableList.of(
                new MatchHeaderSpace(
                    HeaderSpace.builder()
  ...
  public void testToAclLineMatchExpr_any() {
    assertEquals(
        JunosApplication.ANY.toAclLineMatchExpr(null, null),
        new OrMatchExpr(
