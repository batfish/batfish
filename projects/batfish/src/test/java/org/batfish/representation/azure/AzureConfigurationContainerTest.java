...
public class AzureConfigurationContainerTest {
  ...
  private static final Ip CONTAINER_INSTANCE_1_IP =
      Ip.parse("172.17.0.2"); // first IP after subnet router
  ...
  private static final Ip CONTAINER_INSTANCE_2_IP =
      Ip.parse("172.17.0.3"); // first IP after subnet router
  ...
  public void testContainerToContainer() {
    testTrace(
        getAnyFlow(CONTAINER_INSTANCE_1, CONTAINER_INSTANCE_2_IP, _batfish),
        FlowDisposition.ACCEPTED,
        ImmutableList.of(CONTAINER_INSTANCE_1, CONTAINER_INSTANCE_2),
        _batfish);

    testTrace(
        getAnyFlow(CONTAINER_INSTANCE_2, CONTAINER_INSTANCE_1_IP, _batfish),
        FlowDisposition.ACCEPTED,
  ...
  public void testSNatContainerToVm1() {
    ...
    testBidirectionalTrace(
        Flow.builder()
            ...
            .setSrcIp(CONTAINER_INSTANCE_1_IP)
            .setDstIp(VM_1_IP)
            .setSrcPort(1025)
            .setDstPort(80)
