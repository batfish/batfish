...
public class MPIWithLoopNetwork {
  ...
  public static SortedMap<String, Configuration> testMPIWithLoopNetwork() {
    ...
    Interface i12 = nf.interfaceBuilder().setOwner(c1).setVrf(v1).setAddress(c1Addr2).build();
    ...
    Interface i2 = nf.interfaceBuilder().setOwner(c2).setVrf(v2).setAddress(c2Addr).build();
    ...
    nf.interfaceBuilder().setOwner(c3).setVrf(v3).setAddress(c3Addr1).build();
    ConcreteInterfaceAddress c3Addr2 = ConcreteInterfaceAddress.parse("2.2.2.2/32");
    nf.interfaceBuilder().setOwner(c3).setVrf(v3).setAddress(c3Addr2).build();
