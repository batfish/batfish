...
import static org.batfish.vendor.cisco_nxos.grammar.CiscoNxosControlPlaneExtractor.PACKET_LENGTH_RANGE;
import static org.batfish.vendor.cisco_nxos.grammar.CiscoNxosControlPlaneExtractor.TCP_PORT_RANGE;
import static org.batfish.vendor.cisco_nxos.grammar.CiscoNxosControlPlaneExtractor.UDP_PORT_RANGE;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.BGP_LOCAL_WEIGHT;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.DEFAULT_VRF_ID;
...
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.RESOLUTION_POLICY_NAME;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.computeRoutingPolicyName;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.eigrpNeighborExportPolicyName;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.eigrpNeighborImportPolicyName;
import static org.batfish.vendor.cisco_nxos.representation.CiscoNxosConfiguration.eigrpRedistributionPolicyName;
...
import static org.batfish.vendor.cisco_nxos.representation.OspfNetworkType.BROADCAST;
import static org.batfish.vendor.cisco_nxos.representation.OspfNetworkType.POINT_TO_POINT;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_AUTO_COST_REFERENCE_BANDWIDTH_MBPS;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_TIMERS_LSA_ARRIVAL_MS;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_TIMERS_LSA_GROUP_PACING_S;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_TIMERS_THROTTLE_LSA_HOLD_INTERVAL_MS;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_TIMERS_THROTTLE_LSA_MAX_INTERVAL_MS;
import static org.batfish.vendor.cisco_nxos.representation.OspfProcess.DEFAULT_TIMERS_THROTTLE_LSA_START_INTERVAL_MS;
import static org.batfish.vendor.cisco_nxos.representation.TrackInterface.Mode.LINE_PROTOCOL;
...
import org.batfish.vendor.cisco_nxos.representation.BgpGlobalConfiguration;
...
import org.batfish.vendor.cisco_nxos.representation.EigrpVrfIpv6AddressFamilyConfiguration;
...
import org.batfish.vendor.cisco_nxos.representation.InterfaceHsrp;
...
import org.batfish.vendor.cisco_nxos.representation.RedistributionPolicy;
...
import org.batfish.vendor.cisco_nxos.representation.RouteMapMatchRouteType.Type;
...
import org.batfish.vendor.cisco_nxos.representation.StaticRoute.StaticRouteKey;
...
public final class CiscoNxosGrammarTest {
  ...
  private static final String TESTCONFIGS_PREFIX =
      "org/batfish/vendor/cisco_nxos/grammar/testconfigs/";
  private static final String SNAPSHOTS_PREFIX = "org/batfish/vendor/cisco_nxos/grammar/snapshots/";
    ...
    assertThat(c.getVrfs(), hasKeys(DEFAULT_VRF_NAME, MANAGEMENT_VRF_NAME, "VRF"));
    {
      ...
      assertThat(proc.getVrfs(), hasKeys(DEFAULT_VRF_NAME, "VRF", "NON_EXISTENT"));
      {
        ...
        assertThat(
            ...
            equalTo(new org.batfish.vendor.cisco_nxos.representation.EigrpMetric(1, 2, 3, 4, 5)));
      ...
      }
      {
        ...
        assertThat(
            v4.getDefaultMetric(),
            equalTo(new org.batfish.vendor.cisco_nxos.representation.EigrpMetric(5, 4, 3, 2, 1)));
