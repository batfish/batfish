...
public class AristaGrammarTest {
  ...
  public void testBgpNeighborInterfaceExtraction() {
    ...
    // two-word `peer group`
    assertThat(vrf.getInterfaceNeighbors().get("Ethernet7").getPeerGroup(), equalTo("LEAVES"));
  ...
  public void testBgpNeighborInterfaceConversion() {
    ...
    // Et6 inherits shutdown from peer-group SHUT and is dropped; Et99 was removed by `no`;
    // Et100 references a non-existent interface and is dropped with a warning
    assertThat(
        neighbors.keySet(),
        containsInAnyOrder(
            "Ethernet1",
    ...
    // send-community inherited from peer-group LEAVES
    assertThat(
        et1.getIpv4UnicastAddressFamily().getAddressFamilyCapabilities().getSendCommunity(),
        equalTo(true));
    ...
    // EVPN inherited from peer-group LEAVES activate
  ...
  public void testBgpNeighborInterfaceReferences() throws IOException {
    ...
    assertThat(ccae, hasNumReferrers(filename, BGP_PEER_GROUP, "LEAVES", 9));
