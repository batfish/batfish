...
public class AristaGrammarTest {
  ...
  public void testVrfExtraction() {
    ...
    {
      // A VRF may declare multiple import and export EVPN route targets; all are retained in
      // configuration order.
      ...
      assertThat(
          ...
          contains(ExtendedCommunity.target(65000L, 100L), ExtendedCommunity.target(65000L, 200L)));
      assertThat(
          vrf.getExportRouteTargets(),
          contains(ExtendedCommunity.target(65000L, 300L), ExtendedCommunity.target(65000L, 400L)));
    }
  }
