        ...
        BatfishTestUtils.getBatfishFromTestrigText(
            TestrigText.builder()
                .setConfigurationFiles(
                    SNAPSHOTS_PREFIX + snapshotName, ImmutableList.of("frr.conf"))
                .setSonicConfigDbFiles(
                    SNAPSHOTS_PREFIX + snapshotName, ImmutableList.of("config_db.json"))
                .build(),
            _folder);
