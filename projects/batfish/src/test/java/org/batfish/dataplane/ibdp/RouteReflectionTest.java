...
public class RouteReflectionTest {
  ...
  private static <T extends AbstractRouteDecorator> void assertIbgpRoute(
   ...
   */
  private SortedMap<String, SortedMap<String, SortedSet<AbstractRouteDecorator>>>
