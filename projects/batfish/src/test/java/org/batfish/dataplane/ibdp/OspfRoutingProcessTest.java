...
public class OspfRoutingProcessTest {
  ...
  public void testFilterExternalRoutesOnExport() {
    ...
    assertThat(
        _routingProcess
            .filterExternalRoutesOnExport(routes, AREA0_CONFIG, Optional.empty())
            .collect(Collectors.toList()),
  ...
  public void testFilterExternalRoutesOnExportWithInterfaceFilter() {
    ...
    assertThat(
        _routingProcess
            .filterExternalRoutesOnExport(routes, AREA0_CONFIG, Optional.of(rp_accept))
            .collect(Collectors.toList()),
        equalTo(routes.stream().collect(Collectors.toList())));
    ...
    assertThat(
        _routingProcess
            .filterExternalRoutesOnExport(routes, AREA0_CONFIG, Optional.of(rp_reject))
            .collect(Collectors.toList()),
        empty());
