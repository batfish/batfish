...
public class IsisTest {
  ...
  private static void assertInterAreaRoute(
    ...
    SortedMap<String, SortedSet<AbstractRouteDecorator>> routesByVrf = routesByNode.get(hostname);
    assertThat(routesByVrf, hasKey(DEFAULT_VRF_NAME));
    SortedSet<AbstractRouteDecorator> routes = routesByVrf.get(DEFAULT_VRF_NAME);
