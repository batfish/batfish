...
public final class Node extends ComparableStructure<String> {
   ...
   public boolean activateGeneratedRoutes() {
      ...
      for (GeneratedRoute gr : _c.getGeneratedRoutes()) {
         boolean active = true;
      ...
      if (_c.getBgpProcess() != null) {
         ...
         for (BgpAdvertisement advert : externalAdverts) {
            if (advert.getDstNode().equals(_c.getHostname())) {
               ...
               BgpNeighbor neighbor = _c.getBgpProcess().getNeighbors()
                     .get(srcPrefix);
               if (neighbor != null) {
   ...
   public void initBaseOspfRoutes() {
      if (_c.getOspfProcess() != null) {
         ...
         _c.getOspfProcess().getAreas().forEach((areaNum, area) -> {
   ...
   public void initConnectedRib() {
      for (Interface i : _c.getInterfaces().values()) {
         if (i.getActive()) {
   ...
   public void initEbgpTopology(BdpDataPlane dp) {
      if (_c.getBgpProcess() != null) {
         for (BgpNeighbor neighbor : _c.getBgpProcess().getNeighbors()
               .values()) {
   ...
   public void initOspfExports() {
      if (_c.getOspfProcess() != null) {
         // init ospf exports
         String exportPolicyName = _c.getOspfProcess().getExportPolicy();
   ...
   public void initOspfInterfaceCosts() {
      if (_c.getOspfProcess() != null) {
         _c.getInterfaces().forEach((interfaceName, i) -> {
            if (i.getActive()) {
               ...
               if (ospfCost == null) {
                  if (interfaceName.startsWith("Vlan")) {
                     ...
                     if (i.getBandwidth() != null) {
                        ospfCost = Math.max(
                              (int) (_c.getOspfProcess().getReferenceBandwidth()
                                    / i.getBandwidth()),
                              1);
                     }
                     else {
   ...
   public void initStaticRib() {
      for (StaticRoute sr : _c.getStaticRoutes()) {
      ...
      if (_c.getBgpProcess() != null) {
         ...
         for (BgpNeighbor neighbor : _c.getBgpProcess().getNeighbors()
            ...
            if (remoteBgpNeighbor != null) {
               ...
               Node remoteNode = nodes.get(remoteHostname);
               ...
               remoteCandidateRoutes
                     .addAll(remoteNode._prevMainRib.getRoutes());

               // bgp advertise-external
               if (!ebgp && remoteBgpNeighbor.getAdvertiseExternal()) {
                  remoteCandidateRoutes
                        .addAll(remoteNode._prevEbgpRib.getRoutes());
               }

               // bgp advertise-inactive
               if (remoteBgpNeighbor.getAdvertiseInactive()) {
                  remoteCandidateRoutes
                        .addAll(remoteNode._prevBgpRib.getRoutes());
               }
               ...
               for (AbstractRoute remoteRoute : remoteCandidateRoutes) {
                  ...
                  if (remoteRouteIsBgp) {
                     ...
                     if (remoteOriginatorIp != null && _c.getBgpProcess()
                     ...
                     if (remoteRouteProtocol.equals(RoutingProtocol.IBGP)
                        ...
                        if (remoteOriginatorIp != null) {
                           ...
                           originatorIp = remoteConfig.getBgpProcess()
                                 .getRouterId();
                        }
                  ...
                  if (nextHopIp == null) {
                     ...
                     String nextHopInterface = remoteRoute
                           .getNextHopInterface();
                     Prefix nextHopPrefix = remoteConfig.getInterfaces()
   ...
   public boolean propagateOspfExternalRoutes(Map<String, Node> nodes,
      ...
      if (_c.getOspfProcess() != null) {
         ...
         for (Edge edge : edges) {
            ...
            Interface connectingInterface = _c.getInterfaces()
            ...
            OspfArea area = _c.getInterfaces().get(connectingInterfaceName)
                  .getOspfArea();
            ...
            if (connectingInterface.getOspfEnabled()
               ...
               for (OspfExternalType1Route neighborRoute : neighbor._prevOspfExternalType1Rib
                     .getRoutes()) {
               ...
               for (OspfExternalType2Route neighborRoute : neighbor._prevOspfExternalType2Rib
                     .getRoutes()) {
         ...
         for (Edge edge : edges) {
            ...
            if (connectingInterface.getOspfEnabled()
               ...
               if (area.getNumber().equals(neighborArea.getNumber())) {
                  ...
                  for (OspfIntraAreaRoute neighborRoute : neighbor._ospfIntraAreaRib
                        .getRoutes()) {
