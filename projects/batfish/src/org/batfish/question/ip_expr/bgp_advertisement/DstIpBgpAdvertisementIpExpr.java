...
public final class DstIpBgpAdvertisementIpExpr extends BgpAdvertisementIpExpr {

   public DstIpBgpAdvertisementIpExpr(BgpAdvertisementExpr caller) {
      super(caller);
   }
