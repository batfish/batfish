...
public final class ForEachSentEbgpAdvertisementStatement extends
      ForEachStatement<BgpAdvertisement> {

   public ForEachSentEbgpAdvertisementStatement(List<Statement> statements,
   ...
   protected Collection<BgpAdvertisement> getCollection(Environment environment) {
      ...
      return node.getSentEbgpAdvertisements();
   }
   ...
   protected void writeVal(Environment environment, BgpAdvertisement t) {
      environment.setSentEbgpAdvertisement(t);
   }
