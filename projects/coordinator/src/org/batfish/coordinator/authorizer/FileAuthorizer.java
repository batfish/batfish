...
public class FileAuthorizer implements Authorizer {
   ...
   @Override
   public synchronized void authorizeContainer(String apiKey, String containerName) throws Exception {
   ...
   @Override
   public boolean isAccessibleContainer(String apiKey, String containerName) throws Exception {
      String allPerms = FileUtils.readFileToString(_permsFile);      
      JSONObject jObj = new JSONObject(allPerms);
