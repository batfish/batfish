...
public class Settings extends BaseSettings {
   ...
   private String _servicePoolHost;
   private int _servicePoolPort;
   private String _serviceWorkHost;
   ...
   public String getServicePoolHost() {
      return _servicePoolHost;
   }
   ...
   public String getServiceWorkHost() {
      return _serviceWorkHost;
   }
   ...
   private void initConfigDefaults() {
      ...
      setDefaultProperty(ARG_SERVICE_POOL_HOST, "0.0.0.0");
      setDefaultProperty(ARG_SERVICE_POOL_PORT, CoordConsts.SVC_CFG_POOL_PORT);
      setDefaultProperty(ARG_SERVICE_WORK_HOST, "0.0.0.0");
   ...
   private void initOptions() {
      ...
      addOption(ARG_SERVICE_POOL_HOST, "hostname for pool management service",
      ...
      addOption(ARG_SERVICE_WORK_HOST, "hostname for work management service",
   ...
   private void parseCommandLine(String[] args) {
      ...
      _servicePoolHost = getStringOptionValue(ARG_SERVICE_POOL_HOST);
      _servicePoolPort = getIntegerOptionValue(ARG_SERVICE_POOL_PORT);
      _serviceWorkHost = getStringOptionValue(ARG_SERVICE_WORK_HOST);
