...
public class BfConsts {
   ...
   public static final String RELPATH_PROTOCOL_DEPENDENCY_GRAPH_INPUT = "pdgraph.dot";
   public static final String RELPATH_PROTOCOL_DEPENDENCY_GRAPH_OUTPUT = "pdgraph.svg";
