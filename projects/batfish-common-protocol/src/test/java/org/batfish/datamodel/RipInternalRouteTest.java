...
public class RipInternalRouteTest {
  ...
  public void testConstructorAcceptsValidMetric() {
    ...
    for (int m = 0; m <= RipRoute.MAX_ROUTE_METRIC; m++) {
      new RipInternalRoute(new Prefix("1.1.1.1/32"), new Ip("2.2.2.2"), adminCost, m);
    }
  }
  ...
  public void testEquals() {
    ...
    RipInternalRoute r2 =
        new RipInternalRoute(new Prefix("1.1.1.1/32"), new Ip("2.2.2.2"), adminCost, 2);
    // Different admin cost from r1
    RipInternalRoute r3 =
        new RipInternalRoute(new Prefix("1.1.1.1/32"), new Ip("2.2.2.2"), adminCost + 1, 1);
    // Different ip from r1
    RipInternalRoute r4 =
        new RipInternalRoute(new Prefix("1.1.1.1/32"), new Ip("2.2.2.3"), adminCost, 1);
    // Different network from r1
    RipInternalRoute r5 =
        new RipInternalRoute(new Prefix("1.1.1.2/32"), new Ip("2.2.2.2"), adminCost, 2);
    ...
    assertThat(r1, not(equalTo(new Prefix("1.1.1.1/32"))));
  }
}
