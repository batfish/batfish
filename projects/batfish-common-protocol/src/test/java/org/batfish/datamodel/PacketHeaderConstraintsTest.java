...
import org.batfish.datamodel.applications.IcmpApplication;
...
public class PacketHeaderConstraintsTest {
  ...
  public void testResolvePorts() {
    ...
    assertThat(
        resolvePorts(null, ImmutableSet.of(IcmpTypesApplication.ALL)),
        equalTo(null));
  }
  ...
  public void testParseIpProtocolsNegation() throws IOException {
    ...
    assertThat(
        ...
        equalTo(
            Sets.difference(
                ImmutableSet.copyOf(IpProtocol.values()), ImmutableSet.of(ICMP))));
  }
