...
public class Ip6SpaceContainsIpTest {
  ...
  public void testVisitIpSpaceReference_true() {
    ...
    assertTrue(containsIp(ip1).visitIp6SpaceReference(new Ip6SpaceReference(IP_SPACE_NAME)));
    assertFalse(containsIp(ip2).visitIp6SpaceReference(new Ip6SpaceReference(IP_SPACE_NAME)));
    assertFalse(containsIp(ip1).visitIp6SpaceReference(new Ip6SpaceReference("missing ip6Space")));
  }
}
