...
public class BgpRouteCommunityDiffTest {
  ...
  /** Test serialization as a {@link BgpRouteDiff} object. */
  @Test
  public void testJsonSerialization() {
    SortedSet<Community> oldComms = new TreeSet<>();
    SortedSet<Community> newComms = new TreeSet<>();
    oldComms.add(StandardCommunity.of(0));
    oldComms.add(StandardCommunity.of(1));
    newComms.add(StandardCommunity.of(0));
    newComms.add(StandardCommunity.of(2));
    BgpRouteDiff diff = new BgpRouteCommunityDiff(oldComms, newComms);
  ...
  public void testEquals() {
    ...
    assertEquals(
        ...
        new BgpRouteCommunityDiff(oldComms, newComms));
  }
  ...
  public void testDeltaEquals() {
    ...
    assert (comms1.deltaEquals(comms2));
    // but not equal according to BgpRouteDiff
    assertNotEquals(comms1, comms2);
  }
}
