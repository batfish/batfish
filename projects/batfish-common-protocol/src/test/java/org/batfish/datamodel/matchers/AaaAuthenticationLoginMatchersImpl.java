...
public class AaaAuthenticationLoginMatchersImpl {
  ...
  static final class HasLists extends FeatureMatcher<AaaAuthenticationLogin, SortedMap<String, AaaAuthenticationLoginList>> {
    ...
    @Override
    protected SortedMap<String, AaaAuthenticationLoginList> featureValueOf(AaaAuthenticationLogin actual) {
      return actual.getLists();
    }
  }

  static final class HasListForKey extends FeatureMatcher<AaaAuthenticationLogin, AaaAuthenticationLoginList> {
    private String _key;

    HasListForKey(@Nonnull Matcher<? super AaaAuthenticationLoginList> subMatcher, String key) {
      super(subMatcher, "AaaAuthenticationLogin has list for key", "AaaAuthenticationLogin list for key");
      _key = key;
    }
