 ...
 *
 * <p>SVI/IRB/Vlan interfaces connect to the {@link BridgeDomain} they are associated with.
 *
 ...
 */
public final class L3Interface extends Node<Unit> {
  ...
  public void originate(Set<L3Interface> domain, Set<NodeAndState<?, ?>> visited) {
  ...
  public void reached(Set<L3Interface> domain, Set<NodeAndState<?, ?>> visited) {
    domain.add(this);
  }
  ...
  public void sendThroughSwitch(BridgeDomain sw, Edge<Unit, Integer> edge) {
    checkState(
        _sendToInterface == null && _sendToSwitch == null,
        "Cannot connect an L3Interface to two places");
    _sendToSwitch = sw;
  ...
  private @Nullable BridgeDomain _sendToSwitch;
  private @Nullable Edge<Unit, Integer> _sendToSwitchEdge;

  @VisibleForTesting
  @Nullable
  public PhysicalInterface getSendToInterfaceForTesting() {
    return _sendToInterface;
  }

  @VisibleForTesting
  @Nullable
  public BridgeDomain getSendToSwitchForTesting() {
