 ...
 *
 * <p>In their implementation of the {@link SyncTestrigsPlugin#syncTestrigsPluginInitialize()}
 *   the concrete plugin should register with the coordinator by calling
 *   {@link ICoordinator#registerTestrigSyncer(String, SyncTestrigsPlugin)}
 *
 ...
 *   username, password). It is up to the plugin implementation to define what settings are needed
 *   and the assumption is that their users know what is needed.
 *
