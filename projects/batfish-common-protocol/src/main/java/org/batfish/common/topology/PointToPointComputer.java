...
public final class PointToPointComputer {
  ...
  public static @Nonnull PointToPointInterfaces compute(
    ...
    Map<NodeInterfacePair, NodeInterfacePair> subifToParent = computeSubinterfaceToParent(configs);
    return new PointToPointInterfaces(p2p, subifToParent);
  }
   ...
   */
  @VisibleForTesting
  static Map<NodeInterfacePair, NodeInterfacePair> computeSubinterfaceToParent(
