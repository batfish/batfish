 ...
 * for a dot1q encapsulated subinterface/untagged frames directly, or to {@link BridgeDomain} when
 * this interface is a switchport. These are mutually exclusive.
 *
...
public final class PhysicalInterface extends Node<EthernetTag> {
  ...
  public void deliverToSwitch(BridgeDomain sw, Edge<EthernetTag, Integer> edge) {
  ...
  public void transmit(EthernetTag tag, Set<L3Interface> domain, Set<NodeAndState<?, ?>> visited) {
  ...
  public void receive(EthernetTag tag, Set<L3Interface> domain, Set<NodeAndState<?, ?>> visited) {
  ...
  @VisibleForTesting
  public Map<L3Interface, Edge<EthernetTag, Unit>> getL3InterfacesForTest() {
    return _l3Interfaces;
  }

  @VisibleForTesting
  public BridgeDomain getSwitchForTest() {
    return _switch;
  }
  ...
  private @Nullable BridgeDomain _switch;
