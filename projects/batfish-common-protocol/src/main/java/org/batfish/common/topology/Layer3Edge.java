...
public class Layer3Edge implements Comparable<Layer3Edge> {
  ...
  @Nonnull private final List<InterfaceAddress> _interfaceAddresses1;

  @Nonnull private final List<InterfaceAddress> _interfaceAddresses2;
  ...
  private static Layer3Edge jsonCreator(
      ...
      @JsonProperty(PROP_INTERFACE_ADDRESSES1) @Nullable List<InterfaceAddress> interfaceAddresses1,
    ...
    return new Layer3Edge(
        nodeInterface1,
        nodeInterface2,
        firstNonNull(interfaceAddresses1, ImmutableList.of()),
        firstNonNull(interfaceAddresses2, ImmutableList.of()));
  }
  ...
  @Nonnull
  public List<InterfaceAddress> getInterfaceAddresses1() {
    return _interfaceAddresses1;
  }

  @JsonProperty(PROP_INTERFACE_ADDRESSES2)
  @Nonnull
  public List<InterfaceAddress> getInterfaceAddresses2() {
  ...
  public int compareTo(Layer3Edge o) {
    return Comparator.comparing(Layer3Edge::getNodeInterface1)
        ...
        .thenComparing(Layer3Edge::getInterfaceAddresses1, CommonUtil::compareCollection)
        .thenComparing(Layer3Edge::getInterfaceAddresses2, CommonUtil::compareCollection)
        .compare(this, o);
  }
}
