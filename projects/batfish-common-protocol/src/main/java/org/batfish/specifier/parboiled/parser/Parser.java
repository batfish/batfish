...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.APP_PORT;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.DEPRECATED;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.ENUM_SET_NOT;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.ENUM_SET_REGEX;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.ENUM_SET_SET_OP;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.HIDDEN;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_ADDRESS_MASK;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_PREFIX;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_PROTOCOL_NAME;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_PROTOCOL_NOT;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_PROTOCOL_NUMBER;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_PROTOCOL_SET_OP;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_RANGE;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.IP_SPACE_PARENS;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.NAME_SET_NAME;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.NAME_SET_REGEX;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.NAME_SET_SET_OP;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.NODE_AND_FILTER;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.ONE_APP;
...
import static org.batfish.specifier.parboiled.parser.Anchor.Type.VRF_NAME;
import static org.batfish.specifier.parboiled.parser.Anchor.Type.ZONE_NAME;
 ...
 * treated as implicit anchors. See {@code ParserUtils#findPathAnchor}.
 */
@SuppressWarnings({
