...
import org.batfish.specifier.NodeSpecifierFilterSpecifier;
...
final class ParboiledFilterSpecifier implements FilterSpecifier {
  ...
  private final class FilterAstNodeToFilters implements FilterAstNodeVisitor<Set<IpAccessList>> {
    ...
    FilterAstNodeToFilters(Set<String> nodes, SpecifierContext ctxt) {
      _nodes = nodes;
      _ctxt = ctxt;
    }
    ...
    public Set<IpAccessList> visitFilterWithNodeFilterAstNode(
      ...
      return Sets.intersection(
          new NodeSpecifierFilterSpecifier(
                  new ParboiledNodeSpecifier(filterWithNodeFilterAstNode.getNodeAstNode()))
    ...
    public Set<IpAccessList> visitNameFilterAstNode(NameFilterAstNode nameFilterAstNode) {
      return new NameFilterSpecifier(nameFilterAstNode.getName()).resolve(_nodes, _ctxt);
    }
  ...
  public Set<IpAccessList> resolve(Set<String> nodes, SpecifierContext ctxt) {
    return _ast.accept(new FilterAstNodeToFilters(nodes, ctxt));
  }
}
