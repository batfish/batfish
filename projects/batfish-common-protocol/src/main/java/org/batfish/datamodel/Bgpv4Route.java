...
public final class Bgpv4Route extends BgpRoute<Bgpv4Route.Builder, Bgpv4Route> {
  ...
  private Bgpv4Route(
      ...
      boolean nonRouting) {
    super(network, nextHop, admin, attributes, tag, nonForwarding, nonRouting);
  }
  ...
  public Builder toBuilder() {
    return builder()
        ...
        .setReceivedFromIp(_attributes._receivedFromIp)
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        ...
        .add("_receivedFromIp", _attributes._receivedFromIp)
