...
public class Route6 implements Comparable<Route6>, Serializable {
   ...
   public static final Ip6 UNSET_ROUTE_NEXT_HOP_IP = new Ip6(
   ...
   @JsonCreator
   public Route6(@JsonProperty(NODE_VAR) String node,
   ...
   public String prettyPrint(boolean diff) {
      ...
      Ip6 nextHopIp = getNextHopIp();
      String nhip;
      String tag;
      int tagInt = getTag();
      if (tagInt == Route6.UNSET_ROUTE_TAG) {
         tag = "none";
      }
      else {
