  ...
  public static Map<String, PropertyDescriptor<Configuration>> JAVA_MAP =
      new ImmutableMap.Builder<String, PropertyDescriptor<Configuration>>()
          ...
          .put(
              "community-lists",
              new PropertyDescriptor<>(
                  Configuration::getCommunityLists, Schema.list(Schema.STRING)))
          .put(
          ...
          .put(
              "ip6-access-lists",
              new PropertyDescriptor<>(
                  Configuration::getIp6AccessLists, Schema.list(Schema.STRING)))
          .put(
              "ipsec-policies",
          ...
          .put(
              "ipsec-proposals",
              new PropertyDescriptor<>(
                  Configuration::getIpsecProposals, Schema.list(Schema.STRING)))
          .put(
              "ipsec-vpns",
          ...
          .put(
              "logging-servers",
              new PropertyDescriptor<>(
                  Configuration::getLoggingServers, Schema.list(Schema.STRING)))
          .put(
          ...
          .put(
              "routing-policies",
              new PropertyDescriptor<>(
                  Configuration::getRoutingPolicies, Schema.list(Schema.STRING)))
          .put(
          ...
          .put(
              "snmp-trap-servers",
              new PropertyDescriptor<>(
                  Configuration::getSnmpTrapServers, Schema.list(Schema.STRING)))
          .put(
              "tacacs-servers",
          ...
          .put(
              "zones",
              new PropertyDescriptor<>(Configuration::getZones, Schema.list(Schema.STRING)))
          .build();
