...
public class FlowHistory extends AnswerElement {
  ...
  public static class FlowHistoryInfo {
    ...
    public Map<String, Set<Trace>> getPaths() {
      return _paths;
    }
  }
  ...
  public void addFlowTrace(Flow flow, String envTag, Environment environment, Trace trace) {
