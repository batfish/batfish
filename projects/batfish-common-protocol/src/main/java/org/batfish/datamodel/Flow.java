...
public final class Flow implements Comparable<Flow>, Serializable {
  ...
  private static Flow createFlow(
      ...
      @JsonProperty(PROP_TCP_FLAGS_CWR) Integer tcpFlagsCwr,
      @JsonProperty(PROP_TCP_FLAGS_ECE) Integer tcpFlagsEce,
      @JsonProperty(PROP_TCP_FLAGS_URG) Integer tcpFlagsUrg,
      @JsonProperty(PROP_TCP_FLAGS_ACK) Integer tcpFlagsAck,
      @JsonProperty(PROP_TCP_FLAGS_PSH) Integer tcpFlagsPsh,
      @JsonProperty(PROP_TCP_FLAGS_RST) Integer tcpFlagsRst,
      @JsonProperty(PROP_TCP_FLAGS_SYN) Integer tcpFlagsSyn,
      @JsonProperty(PROP_TCP_FLAGS_FIN) Integer tcpFlagsFin,
