...
public class PacketHeaderConstraintsUtil {
  ...
  /**
   * Convert packet header constraints together with src and dst {@link IpSpace} to a {@link
   * HeaderSpace}
   */
  public static HeaderSpace toHeaderSpace(
      PacketHeaderConstraints phc, IpSpace srcIps, IpSpace dstIps) {
    return toHeaderSpaceBuilder(phc).setSrcIps(srcIps).setDstIps(dstIps).build();
  }
