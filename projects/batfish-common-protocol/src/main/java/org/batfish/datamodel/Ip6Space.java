...
public abstract class Ip6Space implements Comparable<Ip6Space>, Serializable {
    ...
    public final boolean containsIp6(@Nonnull Ip6 ip6, @Nonnull Map<String, Ip6Space> namedIp6Spaces) {
    ...
    public Ip6Space complement() {
        //return AclIp6Space.difference(UniverseIpSpace.INSTANCE, this);
        return null;
    }
