...
public final class ForwardingAnalysisImpl implements ForwardingAnalysis {
  ...
  private static Map<String, Map<String, Map<String, IpSpace>>> merge(
    ...
    checkArgument(
        ipSpaces1.keySet().equals(ipSpaces2.keySet()), "Can't merge with different nodes");
    try (ActiveSpan span =
      ...
      return toImmutableMap(
          ...
          nodeEntry -> {
            ...
            checkArgument(
                ...
                "Can't merge with different VRFs in node %s",
                nodeEntry.getKey());
            return toImmutableMap(
                nodeEntry.getValue(),
                Entry::getKey, /* vrf */
                vrfEntry -> {
                  ...
                  checkArgument(
                      ...
                      "Can't merge with different interfaces in node %s VRF %s",
                      nodeEntry.getKey(),
                      vrfEntry.getKey());
                  return toImmutableMap(
                      vrfEntry.getValue(),
