...
public class AclLinesAnswerElement extends TableAnswerElement
  ...
  @JsonCreator
  public AclLinesAnswerElement(@Nonnull @JsonProperty(PROP_METADATA) TableMetadata tableMetadata) {
    super(tableMetadata);
  }
