...
print bf_answer_type("uniqueipassignments")
...
print bf_answer_type("traceroute", ingressNode="host1", dstIp="1.0.2.2")
...
print bf_answer_type("traceroute", ingressNode="as2border1", dstIp="2.128.0.101", dstPort=53, ipProtocol="UDP")
...
print bf_answer_type("reachability", dstIps=["2.128.0.101"], dstPorts=[53], ipProtocols=["UDP"], actions=["drop"])
...
print bf_answer_type("reachability", actions=["ACCEPT"], dstIps=["2.128.1.101"], notDstPorts=[22], notIpProtocols=["TCP"])
...
print bf_answer_type("reachability", actions=["ACCEPT"], dstPorts=[22], dstIps=["2.128.1.101"], ingressNodeRegex="as(1|3)border1", ipProtocols=["TCP"])
...
print bf_answer_type("neighbors", differential=True)

print "# a particularly powerful query: reachability diff between two testrigs"
print bf_answer_type("reachability", type="reduced")
...
print bf_answer_type("reachability", type="multipath")
