...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:2.17.1",
    "com.fasterxml.jackson.module:jackson-module-jaxb-annotations:2.17.1",
    ...
    "junit:junit:4.13.2",
    "net.sourceforge.pmd:pmd-cli:7.3.0",
    "net.sourceforge.pmd:pmd-java:7.3.0",
    ...
    "org.glassfish.jersey.containers:jersey-container-grizzly2-http:2.43",
    "org.glassfish.jersey.core:jersey-client:2.43",
    "org.glassfish.jersey.core:jersey-common:2.43",
    "org.glassfish.jersey.core:jersey-server:2.43",
    "org.glassfish.jersey.inject:jersey-hk2:2.43",
    "org.glassfish.jersey.media:jersey-media-json-jackson:2.43",
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.43", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "2.43", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
