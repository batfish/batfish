...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "com.fasterxml.jackson.module:jackson-module-jaxb-annotations:2.18.1",
    ...
    "junit:junit:4.13.2",
    "net.sourceforge.pmd:pmd-cli:7.7.0",
    "net.sourceforge.pmd:pmd-java:7.7.0",
    ...
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.45", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
