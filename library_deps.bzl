...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "junit:junit:4.13.2",
    "net.sourceforge.pmd:pmd-cli:7.4.0",
    "net.sourceforge.pmd:pmd-java:7.4.0",
    ...
    "org.glassfish.jersey.containers:jersey-container-grizzly2-http:2.44",
    "org.glassfish.jersey.core:jersey-client:2.44",
    "org.glassfish.jersey.core:jersey-common:2.44",
    "org.glassfish.jersey.core:jersey-server:2.44",
    "org.glassfish.jersey.inject:jersey-hk2:2.44",
    "org.glassfish.jersey.media:jersey-media-json-jackson:2.44",
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.44", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "2.44", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
