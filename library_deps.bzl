...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:2.15.3",
    ...
    maven.artifact(group = "com.google.guava", artifact = "guava-testlib", version = "32.1.3-jre", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    ...
    "org.apache.tomcat.embed:tomcat-embed-core:8.5.95",
    ...
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.40", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "2.40", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
