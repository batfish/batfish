...
BATFISH_MAVEN_ARTIFACTS = [
    ...
    "org.glassfish.jersey.containers:jersey-container-grizzly2-http:2.39",
    "org.glassfish.jersey.core:jersey-client:2.39",
    "org.glassfish.jersey.core:jersey-common:2.39",
    "org.glassfish.jersey.core:jersey-server:2.39",
    "org.glassfish.jersey.inject:jersey-hk2:2.39",
    "org.glassfish.jersey.media:jersey-media-json-jackson:2.39",
    maven.artifact(group = "org.glassfish.jersey.test-framework", artifact = "jersey-test-framework-core", version = "2.39", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
    maven.artifact(group = "org.glassfish.jersey.test-framework.providers", artifact = "jersey-test-framework-provider-grizzly2", version = "2.39", exclusions = [maven.exclusion(group = "junit", artifact = "junit")]),
